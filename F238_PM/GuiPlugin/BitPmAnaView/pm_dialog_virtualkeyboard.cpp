...
#include "ui_pm_dialog_virtualkeyboard.h"

Pm_dialog_virtualkeyboard::Pm_dialog_virtualkeyboard(QWidget *parent) :
    QWidget(parent),
    mParent(parent),
    ui(new Ui::Pm_dialog_virtualkeyboard)
{
    ui->setupUi(this);
    mCapLockOn = 0;
    mCtrlFlag = 0;
...
Pm_dialog_virtualkeyboard::~Pm_dialog_virtualkeyboard()
{
    delete ui;
}
void Pm_dialog_virtualkeyboard::initKeyBoard()
{
    qint32 btnCnt;
...
void Pm_dialog_virtualkeyboard::btn_clicked()
{
...
void Pm_dialog_virtualkeyboard::keyPressEvent(QKeyEvent *event)
{
...
void Pm_dialog_virtualkeyboard::CapslockChange()
{
...
void Pm_dialog_virtualkeyboard::ShiftChange()
{
