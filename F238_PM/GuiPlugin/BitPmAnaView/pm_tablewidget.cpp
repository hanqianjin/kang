...
Pm_TableWidget::Pm_TableWidget(QWidget* parent, Qt::WindowFlags f): QTableWidget(parent)
{
...
* @return    void
*/
void Pm_TableWidget::resetAllParam(void)
{
...
* @notify
*/
void Pm_TableWidget::numberProcess(char *number, QString qShowStr,QTableWidgetItem *widgetItem)
{
    if(blFirstIn){
...
* @not
*/
void Pm_TableWidget::leftKeyProcess(void)
{
    QString strValue;
...
* @not
*/
void Pm_TableWidget::rightKeyProcess(void)
{
    QString strValue;
...
* @not
*/
void Pm_TableWidget::upKeyProcess(void)
{
    QString strValue;
...
* @not
*/
void Pm_TableWidget::downKeyProcess(void)
{
    QString strValue;
...
* @not
*/
void Pm_TableWidget::dotKeyProcess(QString qShowStr, QTableWidgetItem *widgetItem)
{
...
* @not
*/
void Pm_TableWidget::espKeyProcess(void)
{
//    emit editFinish();
    sortAllItems();
...
* @not
*/
void Pm_TableWidget::enterKeyProcess(void)
{
    char cTmpValue[20];
...
* @not
*/
void Pm_TableWidget::minusKeyProcess(QString qShowStr, QTableWidgetItem *widgetItem)
{
    if(blFirstIn){
        memset(newDataString,0,sizeof(newDataString));
...
* @not
*/
void Pm_TableWidget::backSpaceKeyProcess(QString qShowStr, QTableWidgetItem *widgetItem)
{
    int strLen = 0;
    char backupStr[21] = {'\0',};
...
* @return    void
*/
void Pm_TableWidget::keyPressEvent(QKeyEvent *event)
{
    QString qShowStr;
...
* @not
*/
void Pm_TableWidget::judgeTableContent(QTableWidget *tableWidget,  qulonglong startFreq,  qulonglong stopFreq, bool bFlag)
{
//    QString strValue;
//    char cTmpValue[20];
//    char cItemValue[20];
...
void Pm_TableWidget::mousePressEvent(QMouseEvent *event)
{
...
* @return    void
*/
void Pm_TableWidget::headerClicked(int index)
{
    if (index != 0)
    {
...
* @return    void
*/
void Pm_TableWidget::sortAllItems(void)
{
...
void Pm_TableWidget::resortAllData()
{
    QString strFreq,strAmplitude;
    QTableWidgetItem *widgetItem;
...
* @date 2019-06-17
*/
void Pm_TableWidget::resetAllData()
{
    QString strFreq,strAmplitude;
    QTableWidgetItem *widgetItem;
...
* @date 2019-03-25
*/
qreal* Pm_TableWidget::getLimitFreq()
{
    return dFreq;
}
/**
...
* @date 2019-03-25
*/
qreal* Pm_TableWidget::getLimitAmpt()
{
    return dAmplitude;
}
/**
...
* @date 2019-09-10
*/
void Pm_TableWidget::judgeFmtTableContent(QTableWidget *tableWidget, qulonglong startFreq, qulonglong stopFreq, bool bFlag)
{
//    QString strValue;
//    char cTmpValue[20];
//    char cItemValue[20];
