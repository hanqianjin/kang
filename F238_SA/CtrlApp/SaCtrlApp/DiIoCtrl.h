...
//#define BIT_F238
//Johnson 191025
#define DEBUG_OUTPUT 0//1 means debug message output,0 means debug message close 

//#define SEG_CHANGE_NEW 1 // 0 means use old Strict subsection control, 1 means adjust subsection control
//#define SEG_START_STOP_NEW 0
#define SEG_MINSPAN	20000000.0
#define SEG_START_STOP_EXTENSION	100000.0
//==============================================================================
// Types
