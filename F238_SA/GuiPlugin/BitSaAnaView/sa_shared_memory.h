...
//index sbu flag ---- config trigger and gateview control
#define IXS_SA_GATEVIEW                            0x80000000
//index sbu flag ---- config trigger
#define IXS_SA_TriggerMode						   0x80000001
#define IXS_SA_TriggerDirect                       0x80000002
#define IXS_SA_TriggerDelayTime                    0x80000004
#define IXS_SA_TriggerPerTime                      0x80000008
#define IXS_SA_VedioTriggerAmp                     0x80000010
#define IXS_SA_RFBurstTriggerAmp                   0x80000020

//index sbu flag ---- config trigger
#define IXS_SA_DrCtrlSource                   0x80000040
#define IXS_SA_LvlEdgModeSelect               0x80000080
#define IXS_SA_LvlEdgValueSelect              0x80000100
#define IXS_SA_DrCtrlSweepMode                0x80000200
#define IXS_SA_PrdTrigSycSrcSelect            0x80000400
#define IXS_SA_DrCtrlSweepSwitch              0x80000800

#define IXS_SA_EdgTrigDelay                   0x80001000
#define IXS_SA_EdgTrigDrWidth                 0x80002000
#define IXS_SA_EdgTrigPrvtSwitch	          0x80004000
#define IXS_SA_EdgTrigPrvtValue               0x80008000
#define IXS_SA_RFBurst_TrigLevel              0x80010000

#define IXS_SA_PrdTrigPeriod                  0x80020000
#define IXS_SA_PrdTrigSycSrcDelay             0x80040000
#define IXS_SA_PrdTrigPrvtSwitch	          0x80080000
#define IXS_SA_PrdTrigPrvtValue               0x80100000
...
//#define IXS_SA_GATEVIEW                       0x00008000
...
{
    quint32 rbwkHz;         //rbw
    qreal sampRateHz;	 //the fds    unused
    qreal stepFreqHz;	 //lo step
    quint32 fftNum;		     //FFT num
    qreal winAlpha;		 //win coef   unused
    qreal respondTimeus;	 //respond time(switch channel and IF fliter time)     unused
    qreal validRatio;     //efficient
    quint32 singleacqTime;		 //the num of fs    unused
    qreal tsms;
    quint32 orderNum;
...
typedef struct
{
    ...
    qint64 segmentsDataSumNum;//from start to end all points num
#ifdef SA_F239
    SA_FFT_FIR_COMMON_NUM comNum[14];
#endif
#ifdef SA_F238
    SA_FFT_FIR_COMMON_NUM comNum[19];//Johnson 190919
#endif
#ifdef SA_F238_SMART
    SA_FFT_FIR_COMMON_NUM comNum[7];
#endif
...
{
    quint32 noticode;
}SA_ALL_NOTIC_CODE,*SA_PALL_NOTIC_CODE;
