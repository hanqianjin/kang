...
#include "ui_sa_dialog_virtualkeyboard.h"

SA_Dialog_VirtualKeyboard::SA_Dialog_VirtualKeyboard(QWidget *parent) :
    QWidget(parent),
    mParent(parent),
    ui(new Ui::SA_Dialog_VirtualKeyboard)
{
    ui->setupUi(this);
    mCapLockOn = 0;
    mCtrlFlag = 0;
...
void SA_Dialog_VirtualKeyboard::init()
{
    if(mCapLockOn) CapslockChange();
    if(mShiftFlag) ShiftChange();
}
SA_Dialog_VirtualKeyboard::~SA_Dialog_VirtualKeyboard()
{
    delete ui;
}

void SA_Dialog_VirtualKeyboard::initKeyBoard()
{
    qint32 btnCnt;
...
void SA_Dialog_VirtualKeyboard::btn_clicked()
{
...
void SA_Dialog_VirtualKeyboard::keyPressEvent(QKeyEvent *event)
{
...
void SA_Dialog_VirtualKeyboard::CapslockChange()
{
...
void SA_Dialog_VirtualKeyboard::ShiftChange()
{
