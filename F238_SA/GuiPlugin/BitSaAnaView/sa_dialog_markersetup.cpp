...
void SA_Dialog_MarkerSetup::initWidget()
{
    ...
    else
    {
        ...
        ui->pb_FreqCount->setVisible(true);
        ui->lblFreqCount->setVisible(true);
...
void SA_Dialog_MarkerSetup::mMarkerSelectGroup_click(qint32 index)
{
    ...
    //Johnson 191218
    qint32 currentMarkerNoiseStatus = mControl->getMarkerNoiseStatus();
    mControl->setMarkerNoiseStatus(currentMarkerNoiseStatus,globalUserVariable->gMarkerSelect,false);
...
void SA_Dialog_MarkerSetup::refreshMarkerState()
{
    qint32 mkrVisable = mControl->getMarkerViewStatus();
    ui->pb_toggle->setChecked(mkrVisable);

    qint32 mkrType = mControl->getMarkerType();
 ...
 * @since 2018-12-24
*/
void SA_Dialog_MarkerSetup::editclicked(qint32 index)
{
...
void SA_Dialog_MarkerSetup::refreshDisplay()
{
    ...
    markerSelect(mCurMkr);
    mMarkerSelectGroup->button(mCurMkr)->setChecked(true);
    refreshMarker(mCurMkr);
