...
public://Johnson 0802
    ...
    // 2020-11-19 just for measure swap, do not for file use
    void saveMeasureState(_MEASURE_STATE_ &measureState);
    void loadMeasureState(_MEASURE_STATE_ &measureState);
};
