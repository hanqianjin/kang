...
static QColor TraceColor[SA_COLORMODE_CNT][TRACE_CNT_TOTAL] =
{
    ...
    // SA_OUTDOOR_COLOR
    {QColor(0,112,255),QColor(0,255,47),QColor(255, 237, 0),QColor(213, 135, 255),QColor(39, 255, 252),QColor(255, 89, 172)},
    // SA_NIGHT_COLOR
    {QColor(255, 237, 0),QColor(0,255,47),QColor(0,112,255),QColor(213, 135, 255),QColor(39, 255, 252),QColor(255, 89, 172)},
};
...
static QColor TableSelectFontColor[SA_COLORMODE_CNT] =
{
    // SA_INDOOR_COLOR
    QColor(250,210,120),
    // SA_OUTDOOR_COLOR
