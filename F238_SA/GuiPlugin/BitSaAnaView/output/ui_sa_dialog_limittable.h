...
""));
    ...
    {
        SA_Dialog_LimitTable->setWindowTitle(QApplication::translate("SA_Dialog_LimitTable", "Form", Q_NULLPTR));
        SA_Dialog_LimitTable->setProperty("status", QVariant(QApplication::translate("SA_Dialog_LimitTable", "night", Q_NULLPTR)));
        lblTitle->setText(QApplication::translate("SA_Dialog_LimitTable", "Edit Limit", Q_NULLPTR));
...
"Row", Q_NULLPTR));
        pb_DeleteLimit->setText(QApplication::translate("SA_Dialog_LimitTable", "Delete Limit", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("SA_Dialog_LimitTable", "1", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->verticalHeaderItem(0);
        ___qtablewidgetitem1->setText(QApplication::translate("SA_Dialog_LimitTable", "1", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->verticalHeaderItem(1);
        ___qtablewidgetitem2->setText(QApplication::translate("SA_Dialog_LimitTable", "2", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget->verticalHeaderItem(2);
        ___qtablewidgetitem3->setText(QApplication::translate("SA_Dialog_LimitTable", "3", Q_NULLPTR));

        const bool __sortingEnabled = tableWidget->isSortingEnabled();
        tableWidget->setSortingEnabled(false);
        QTableWidgetItem *___qtablewidgetitem4 = tableWidget->item(0, 0);
        ___qtablewidgetitem4->setText(QApplication::translate("SA_Dialog_LimitTable", "123", Q_NULLPTR));
