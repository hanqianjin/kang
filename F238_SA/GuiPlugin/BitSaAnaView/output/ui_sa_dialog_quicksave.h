...
""));
    ...
    {
        SA_Dialog_QuickSave->setWindowTitle(QApplication::translate("SA_Dialog_QuickSave", "Dialog", Q_NULLPTR));
        SA_Dialog_QuickSave->setProperty("status", QVariant(QApplication::translate("SA_Dialog_QuickSave", "night", Q_NULLPTR)));
        pb_clear->setText(QApplication::translate("SA_Dialog_QuickSave", "Clear", Q_NULLPTR));
        inputEdit->setText(QApplication::translate("SA_Dialog_QuickSave", "Trace_0000.png", Q_NULLPTR));
        pb_cancel->setText(QApplication::translate("SA_Dialog_QuickSave", "Cancel", Q_NULLPTR));
        pb_ok->setText(QApplication::translate("SA_Dialog_QuickSave", "OK", Q_NULLPTR));
