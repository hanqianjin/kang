...
"}"));
    ...
    {
        SA_Dialog_MarkerSetup->setWindowTitle(QApplication::translate("SA_Dialog_MarkerSetup", "Form", Q_NULLPTR));
        SA_Dialog_MarkerSetup->setProperty("status", QVariant(QApplication::translate("SA_Dialog_MarkerSetup", "night", Q_NULLPTR)));
        lblTitle->setText(QApplication::translate("SA_Dialog_MarkerSetup", "Marker", Q_NULLPTR));
        pb_cancel->setText(QString());
        label->setText(QApplication::translate("SA_Dialog_MarkerSetup", "Marker", Q_NULLPTR));
        pb_M6->setText(QApplication::translate("SA_Dialog_MarkerSetup", "M6", Q_NULLPTR));
        pb_M2->setText(QApplication::translate("SA_Dialog_MarkerSetup", "M2", Q_NULLPTR));
        pb_M5->setText(QApplication::translate("SA_Dialog_MarkerSetup", "M5", Q_NULLPTR));
        pb_M3->setText(QApplication::translate("SA_Dialog_MarkerSetup", "M3", Q_NULLPTR));
        pb_M1->setText(QApplication::translate("SA_Dialog_MarkerSetup", "M1", Q_NULLPTR));
        pb_M4->setText(QApplication::translate("SA_Dialog_MarkerSetup", "M4", Q_NULLPTR));
        pb_toggle->setText(QApplication::translate("SA_Dialog_MarkerSetup", "Off", Q_NULLPTR));
        lblNoiseMkr->setText(QApplication::translate("SA_Dialog_MarkerSetup", "Noise\n"
"Marker", Q_NULLPTR));
        pb_MkrNoise->setText(QApplication::translate("SA_Dialog_MarkerSetup", "Off", Q_NULLPTR));
        pb_Normal->setText(QApplication::translate("SA_Dialog_MarkerSetup", "Normal", Q_NULLPTR));
        pb_Delta->setText(QApplication::translate("SA_Dialog_MarkerSetup", "Delta", Q_NULLPTR));
        pb_DeltaPair->setText(QApplication::translate("SA_Dialog_MarkerSetup", "Delta Pair", Q_NULLPTR));
...
"Edit", Q_NULLPTR));
        pb_FreqCount->setText(QApplication::translate("SA_Dialog_MarkerSetup", "Off", Q_NULLPTR));
        label_5->setText(QApplication::translate("SA_Dialog_MarkerSetup", "Marker\n"
"View", Q_NULLPTR));
        pb_Start->setText(QApplication::translate("SA_Dialog_MarkerSetup", "Start", Q_NULLPTR));
        pb_Stop->setText(QApplication::translate("SA_Dialog_MarkerSetup", "Stop", Q_NULLPTR));
        pb_Center->setText(QApplication::translate("SA_Dialog_MarkerSetup", "Center", Q_NULLPTR));
        lblMarkerTo->setText(QApplication::translate("SA_Dialog_MarkerSetup", "Marker to", Q_NULLPTR));
        pb_MkrAllOn->setText(QApplication::translate("SA_Dialog_MarkerSetup", "Marker All On", Q_NULLPTR));
    } // retranslateUi
