...
"}"));
    ...
    {
        SA_Dialog_MeasureSetup->setWindowTitle(QApplication::translate("SA_Dialog_MeasureSetup", "Form", Q_NULLPTR));
        SA_Dialog_MeasureSetup->setProperty("status", QVariant(QApplication::translate("SA_Dialog_MeasureSetup", "indoor", Q_NULLPTR)));
        pb_SpuriousEmssionMask->setText(QApplication::translate("SA_Dialog_MeasureSetup", "Spurious Emission", Q_NULLPTR));
        pb_Adjacent->setText(QApplication::translate("SA_Dialog_MeasureSetup", "Multi-Adjacent Channel Power", Q_NULLPTR));
        pb_AudioDemodulation->setText(QApplication::translate("SA_Dialog_MeasureSetup", "AM/FM Audio Demodulation", Q_NULLPTR));
        pb_SpecEmissionMask->setText(QApplication::translate("SA_Dialog_MeasureSetup", "Spectrum Emission Mask", Q_NULLPTR));
        pb_FieldStrength->setText(QApplication::translate("SA_Dialog_MeasureSetup", "Field Strength", Q_NULLPTR));
        pb_Muti_Adjacent->setText(QApplication::translate("SA_Dialog_MeasureSetup", "Adjacent Channel Power", Q_NULLPTR));
        pb_OccupiedBW->setText(QApplication::translate("SA_Dialog_MeasureSetup", "Occupied BW", Q_NULLPTR));
        pb_Spectrum->setText(QApplication::translate("SA_Dialog_MeasureSetup", "Swept SA", Q_NULLPTR));
        lblTitle->setText(QApplication::translate("SA_Dialog_MeasureSetup", "Measure", Q_NULLPTR));
        pb_ChannelPower->setText(QApplication::translate("SA_Dialog_MeasureSetup", "Channel Power", Q_NULLPTR));
