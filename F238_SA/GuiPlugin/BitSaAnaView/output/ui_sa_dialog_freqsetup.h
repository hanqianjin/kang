...
"}"));
    ...
    {
        SA_Dialog_FreqSetup->setWindowTitle(QApplication::translate("SA_Dialog_FreqSetup", "Form", Q_NULLPTR));
        SA_Dialog_FreqSetup->setProperty("status", QVariant(QApplication::translate("SA_Dialog_FreqSetup", "night", Q_NULLPTR)));
...
"Number", Q_NULLPTR));
        LedCHStandard->setText(QApplication::translate("SA_Dialog_FreqSetup", "CDMA-Band 0(800)", Q_NULLPTR));
        LedStopFreq->setText(QApplication::translate("SA_Dialog_FreqSetup", "1,000.000 MHz", Q_NULLPTR));
        lblFreqStep->setText(QApplication::translate("SA_Dialog_FreqSetup", "Frequency\n"
"Step", Q_NULLPTR));
        LedCenterFreq->setText(QApplication::translate("SA_Dialog_FreqSetup", "1,000.000 MHz", Q_NULLPTR));
        LedCenterFreq->setProperty("status", QVariant(QApplication::translate("SA_Dialog_FreqSetup", "outdoor", Q_NULLPTR)));
        lblChStep->setText(QApplication::translate("SA_Dialog_FreqSetup", "Channel\n"
"Step", Q_NULLPTR));
        lblSpan->setText(QApplication::translate("SA_Dialog_FreqSetup", "Span", Q_NULLPTR));
        LedStartFreq->setText(QApplication::translate("SA_Dialog_FreqSetup", "1,000.000 MHz", Q_NULLPTR));
        LedCHNum->setText(QApplication::translate("SA_Dialog_FreqSetup", "1", Q_NULLPTR));
        LedSpan->setText(QApplication::translate("SA_Dialog_FreqSetup", "1,000.000 MHz", Q_NULLPTR));
        lblFreqOffset->setText(QApplication::translate("SA_Dialog_FreqSetup", "Frequency\n"
"Offset", Q_NULLPTR));
        LedFreqOffset->setText(QApplication::translate("SA_Dialog_FreqSetup", "0.000 MHz", Q_NULLPTR));
        pb_FullSpan->setText(QApplication::translate("SA_Dialog_FreqSetup", "Full\n"
"Span", Q_NULLPTR));
        LedCHStep->setText(QApplication::translate("SA_Dialog_FreqSetup", "1", Q_NULLPTR));
...
"Frequency", Q_NULLPTR));
        LedFreqStep->setText(QApplication::translate("SA_Dialog_FreqSetup", "1.000 MHz", Q_NULLPTR));
        lblChType->setText(QApplication::translate("SA_Dialog_FreqSetup", "Channel\n"
"Type", Q_NULLPTR));
        pb_Uplink->setText(QApplication::translate("SA_Dialog_FreqSetup", "Uplink", Q_NULLPTR));
        pb_Downlink->setText(QApplication::translate("SA_Dialog_FreqSetup", "Downlink", Q_NULLPTR));
        lblTitle->setText(QApplication::translate("SA_Dialog_FreqSetup", "Frequency", Q_NULLPTR));
