...
"font-weight:bold;"));
    ...
    {
        SA_Dialog_Warning->setWindowTitle(QApplication::translate("SA_Dialog_Warning", "Form", Q_NULLPTR));
        Title->setText(QApplication::translate("SA_Dialog_Warning", "Notice", Q_NULLPTR));
        Warning->setText(QApplication::translate("SA_Dialog_Warning", "Are you sure to clean all?", Q_NULLPTR));
