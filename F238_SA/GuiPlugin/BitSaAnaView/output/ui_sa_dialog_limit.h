...
""));
    ...
    {
        SA_Dialog_Limit->setWindowTitle(QApplication::translate("SA_Dialog_Limit", "Form", Q_NULLPTR));
        SA_Dialog_Limit->setProperty("status", QVariant(QApplication::translate("SA_Dialog_Limit", "night", Q_NULLPTR)));
        lblTitle->setText(QApplication::translate("SA_Dialog_Limit", "Limit", Q_NULLPTR));
        pb_cancel->setText(QString());
        lblLimitLine->setText(QApplication::translate("SA_Dialog_Limit", "Limit Line", Q_NULLPTR));
        pb_toggle->setText(QApplication::translate("SA_Dialog_Limit", "Off", Q_NULLPTR));
        pb_EditMask->setText(QApplication::translate("SA_Dialog_Limit", "Edit Limit Line Table", Q_NULLPTR));
        pb_EditMask->setProperty("status", QVariant(QApplication::translate("SA_Dialog_Limit", "outdoor", Q_NULLPTR)));
        pb_LM1->setText(QApplication::translate("SA_Dialog_Limit", "Limit1", Q_NULLPTR));
        pb_LM2->setText(QApplication::translate("SA_Dialog_Limit", "Limit2", Q_NULLPTR));
        pb_LM3->setText(QApplication::translate("SA_Dialog_Limit", "Limit3", Q_NULLPTR));
        pb_LM4->setText(QApplication::translate("SA_Dialog_Limit", "Limit4", Q_NULLPTR));
        pb_LM5->setText(QApplication::translate("SA_Dialog_Limit", "Limit5", Q_NULLPTR));
        pb_LM6->setText(QApplication::translate("SA_Dialog_Limit", "Limit6", Q_NULLPTR));
        pb_Edge->setText(QApplication::translate("SA_Dialog_Limit", "Off", Q_NULLPTR));
        lblLimitEdge->setText(QApplication::translate("SA_Dialog_Limit", "Limit Edge", Q_NULLPTR));
        lineEdit->setInputMask(QString());
        lineEdit->setPlaceholderText(QString());
        pb_LimitTest->setText(QApplication::translate("SA_Dialog_Limit", "Off", Q_NULLPTR));
        lblLimitTest->setText(QApplication::translate("SA_Dialog_Limit", "Limit Test", Q_NULLPTR));
        pb_Upper->setText(QApplication::translate("SA_Dialog_Limit", "Upper", Q_NULLPTR));
        pb_Lower->setText(QApplication::translate("SA_Dialog_Limit", "Lower", Q_NULLPTR));
        lblLimitType->setText(QApplication::translate("SA_Dialog_Limit", "Limit Type", Q_NULLPTR));
        pb_DeleteAll->setText(QApplication::translate("SA_Dialog_Limit", "Delete All  Limits", Q_NULLPTR));
        lblEditLimitEdge->setText(QApplication::translate("SA_Dialog_Limit", "Edit Limit\n"
"Edge", Q_NULLPTR));
        lblLimit->setText(QApplication::translate("SA_Dialog_Limit", "Limit", Q_NULLPTR));
...
"Limit", Q_NULLPTR));
        pb_UpperLimit->setText(QApplication::translate("SA_Dialog_Limit", "Off", Q_NULLPTR));
        pb_LowerLimit->setText(QApplication::translate("SA_Dialog_Limit", "Off", Q_NULLPTR));
        ...
        pb_ATLdbcLimit->setText(QApplication::translate("SA_Dialog_Limit", "Off", Q_NULLPTR));
