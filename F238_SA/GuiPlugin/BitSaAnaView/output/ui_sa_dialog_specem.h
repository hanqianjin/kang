...
"}"));
    ...
    {
        SA_Dialog_SpecEM->setWindowTitle(QApplication::translate("SA_Dialog_SpecEM", "Form", Q_NULLPTR));
        lblTitle->setText(QApplication::translate("SA_Dialog_SpecEM", "SEM", Q_NULLPTR));
        pb_cancel->setText(QString());
        lbl_Speed->setText(QApplication::translate("SA_Dialog_SpecEM", "Sweep\n"
"Speed", Q_NULLPTR));
        pb_Speed_Normal->setText(QApplication::translate("SA_Dialog_SpecEM", "Normal", Q_NULLPTR));
        pb_Speed_Fast->setText(QApplication::translate("SA_Dialog_SpecEM", "Fast", Q_NULLPTR));
        MaskBox->clear();
        MaskBox->insertItems(0, QStringList()
         << QApplication::translate("SA_Dialog_SpecEM", "Cat A, > 3 GHz", Q_NULLPTR)
         << QApplication::translate("SA_Dialog_SpecEM", "Cat B, > 3 GHz", Q_NULLPTR)
         << QApplication::translate("SA_Dialog_SpecEM", " 31< P < 38 dBm, > 3 GHz", Q_NULLPTR)
         << QApplication::translate("SA_Dialog_SpecEM", " P < 31 dBm, > 3 GHz", Q_NULLPTR)
        );
        lblVBWValue_3->setText(QApplication::translate("SA_Dialog_SpecEM", "REF CH BW", Q_NULLPTR));
        lblBSPowerValue->setText(QApplication::translate("SA_Dialog_SpecEM", "BS Power (31dBm <P<=38dBm)", Q_NULLPTR));
        lblVBWValue_5->setText(QApplication::translate("SA_Dialog_SpecEM", "Select Mask", Q_NULLPTR));
        pb_Display_Abs->setText(QApplication::translate("SA_Dialog_SpecEM", "Abs Peak Pwr && Freq", Q_NULLPTR));
        pb_Display_IntePwr->setText(QApplication::translate("SA_Dialog_SpecEM", "Integrated Power", Q_NULLPTR));
        pb_Display_Ref->setText(QApplication::translate("SA_Dialog_SpecEM", "Rel Peak Pwr && Freq", Q_NULLPTR));
        pb_ref_SpecPk->setText(QApplication::translate("SA_Dialog_SpecEM", "Spectrum Pk Ref", Q_NULLPTR));
        pb_ref_PSD->setText(QApplication::translate("SA_Dialog_SpecEM", "PSD Ref", Q_NULLPTR));
        pb_ref_TotalPwr->setText(QApplication::translate("SA_Dialog_SpecEM", "Total Pwr Ref", Q_NULLPTR));
        label_22->setText(QApplication::translate("SA_Dialog_SpecEM", "Display Type", Q_NULLPTR));
        RefBox->clear();
        RefBox->insertItems(0, QStringList()
         << QApplication::translate("SA_Dialog_SpecEM", "Total Pwr Ref", Q_NULLPTR)
         << QApplication::translate("SA_Dialog_SpecEM", "PSD Ref", Q_NULLPTR)
         << QApplication::translate("SA_Dialog_SpecEM", "Spectrum Pk Ref", Q_NULLPTR)
        );
        label_23->setText(QApplication::translate("SA_Dialog_SpecEM", "Reference Type", Q_NULLPTR));
        DisplayBox->clear();
        DisplayBox->insertItems(0, QStringList()
         << QApplication::translate("SA_Dialog_SpecEM", "Abs Peak Pwr & Freq", Q_NULLPTR)
         << QApplication::translate("SA_Dialog_SpecEM", "Rel Peak Pwr & Freq", Q_NULLPTR)
         << QApplication::translate("SA_Dialog_SpecEM", "Integrated Power", Q_NULLPTR)
        );
    } // retranslateUi
