...
"}"));
    ...
    {
        SA_Dialog_MarkerSingle->setWindowTitle(QApplication::translate("SA_Dialog_MarkerSingle", "Form", Q_NULLPTR));
#ifndef QT_NO_STATUSTIP
        SA_Dialog_MarkerSingle->setStatusTip(QString());
#endif // QT_NO_STATUSTIP
        SA_Dialog_MarkerSingle->setProperty("status", QVariant(QApplication::translate("SA_Dialog_MarkerSingle", "night", Q_NULLPTR)));
        lblFreq->setText(QApplication::translate("SA_Dialog_MarkerSingle", "1.000 000 000 GHz", Q_NULLPTR));
        pb_PeakSearch->setText(QApplication::translate("SA_Dialog_MarkerSingle", "Peak Search", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        pb_PeakSearch->setShortcut(QString());
#endif // QT_NO_SHORTCUT
        pb_Delta->setText(QApplication::translate("SA_Dialog_MarkerSingle", "Delta", Q_NULLPTR));
        pb_Start->setText(QApplication::translate("SA_Dialog_MarkerSingle", "Start", Q_NULLPTR));
        pb_Normal->setText(QApplication::translate("SA_Dialog_MarkerSingle", "Normal", Q_NULLPTR));
        pb_Stop->setText(QApplication::translate("SA_Dialog_MarkerSingle", "Stop", Q_NULLPTR));
        pb_close->setText(QString());
        pb_NextPeak->setText(QApplication::translate("SA_Dialog_MarkerSingle", "Next Peak", Q_NULLPTR));
        lblTitle->setText(QApplication::translate("SA_Dialog_MarkerSingle", "M2", Q_NULLPTR));
        pb_MinSearch->setText(QApplication::translate("SA_Dialog_MarkerSingle", "Min Search", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        pb_MinSearch->setShortcut(QString());
#endif // QT_NO_SHORTCUT
        pb_PeakLeft->setText(QApplication::translate("SA_Dialog_MarkerSingle", "Next Peak Left", Q_NULLPTR));
        lblAmpt->setText(QApplication::translate("SA_Dialog_MarkerSingle", "-10.01 dB", Q_NULLPTR));
        pb_Center->setText(QApplication::translate("SA_Dialog_MarkerSingle", "Center", Q_NULLPTR));
        pb_PeakRight->setText(QApplication::translate("SA_Dialog_MarkerSingle", "Next Peak Right", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        pb_PeakRight->setShortcut(QString());
#endif // QT_NO_SHORTCUT
        lblPeak->setText(QApplication::translate("SA_Dialog_MarkerSingle", "Peak", Q_NULLPTR));
        lblMarkerTo->setText(QApplication::translate("SA_Dialog_MarkerSingle", "Marker to", Q_NULLPTR));
        pb_Delta_Pair->setText(QApplication::translate("SA_Dialog_MarkerSingle", "Delta Pair", Q_NULLPTR));
        pb_Mkr_On->setText(QApplication::translate("SA_Dialog_MarkerSingle", "Off", Q_NULLPTR));
        pb_PeakTrack->setText(QApplication::translate("SA_Dialog_MarkerSingle", "Off", Q_NULLPTR));
