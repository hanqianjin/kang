...
"}"));
    ...
    {
        SA_Dialog_DigitInput->setWindowTitle(QApplication::translate("SA_Dialog_DigitInput", "Form", Q_NULLPTR));
        SA_Dialog_DigitInput->setProperty("status", QVariant(QApplication::translate("SA_Dialog_DigitInput", "indoor", Q_NULLPTR)));
        lblTitle->setText(QApplication::translate("SA_Dialog_DigitInput", "Frequency", Q_NULLPTR));
        pb_cancel->setText(QString());
        lblValue->setText(QApplication::translate("SA_Dialog_DigitInput", "1000000.0 GHz", Q_NULLPTR));
        ...
        amptBtnUnit1->setText(QApplication::translate("SA_Dialog_DigitInput", "W", Q_NULLPTR));
        amptBtnUnit2->setText(QApplication::translate("SA_Dialog_DigitInput", "mW", Q_NULLPTR));
        amptBtnUnit3->setText(QApplication::translate("SA_Dialog_DigitInput", "uW", Q_NULLPTR));
        amptBtnUnit4->setText(QApplication::translate("SA_Dialog_DigitInput", "nW", Q_NULLPTR));
        amptBtnUnit5->setText(QApplication::translate("SA_Dialog_DigitInput", "pW", Q_NULLPTR));
        amptBtnUnit6->setText(QApplication::translate("SA_Dialog_DigitInput", "fW", Q_NULLPTR));
        amptBtnUnit7->setText(QApplication::translate("SA_Dialog_DigitInput", "aW", Q_NULLPTR));
    } // retranslateUi
