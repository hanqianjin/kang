...
"}"));
    ...
    {
        sa_dialog_chnlpowerset->setWindowTitle(QApplication::translate("sa_dialog_chnlpowerset", "Form", Q_NULLPTR));
        ltitle->setText(QApplication::translate("sa_dialog_chnlpowerset", "Channel Power", Q_NULLPTR));
        pb_cancel_2->setText(QString());
        label->setText(QApplication::translate("sa_dialog_chnlpowerset", "Integrated\n"
"Bandwidth", Q_NULLPTR));
        lineEdit->setText(QApplication::translate("sa_dialog_chnlpowerset", "3.000 MHz", Q_NULLPTR));
        lineEdit_2->setText(QApplication::translate("sa_dialog_chnlpowerset", "3.000 MHz", Q_NULLPTR));
