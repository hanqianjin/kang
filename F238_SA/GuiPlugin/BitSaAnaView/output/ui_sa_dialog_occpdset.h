...
"}"));
    ...
    {
        sa_dialog_occpdset->setWindowTitle(QApplication::translate("sa_dialog_occpdset", "Form", Q_NULLPTR));
        ltitle->setText(QApplication::translate("sa_dialog_occpdset", "Occupied BW", Q_NULLPTR));
        pb_cancel_2->setText(QString());
        label->setText(QApplication::translate("sa_dialog_occpdset", "OccBW%Pwr", Q_NULLPTR));
        lineEdit->setText(QApplication::translate("sa_dialog_occpdset", "99.00%", Q_NULLPTR));
        lineEdit_1->setText(QApplication::translate("sa_dialog_occpdset", "-26.00dB", Q_NULLPTR));
        label_2->setText(QApplication::translate("sa_dialog_occpdset", "XdB", Q_NULLPTR));
    } // retranslateUi
