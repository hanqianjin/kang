...
private slots:
    ...
    //void on_spinbox_PerGateDelay_valueChanged(double arg1);

    //void on_spinbox_PerGateLength_valueChanged(double arg1);

    //void on_spinbox_ExternGateDelay_valueChanged(double arg1);

    //void on_spinbox_ExternGateLength_valueChanged(double arg1);

    //void on_spinbox_RFGateDelay_valueChanged(double arg1);

    //void on_spinbox_RFGateLength_valueChanged(double arg1);
...
private:
    ...
    enum{
        SA_EXTERN_GATEDELAY_LEFT = 0,
        SA_EXTERN_GATEDELAY_RIGHT,
        SA_EXTERN_GATELENGTH_LEFT,
        SA_EXTERN_GATELENGTH_RIGHT,
        SA_RF_GATEDELAY_LEFT,
        SA_RF_GATEDELAY_RIGHT,
        SA_RF_GATELENGTH_LEFT,
        SA_RF_GATELENGTH_RIGHT,
        SA_PERI_GATEDELAY_LEFT,
        SA_PERI_GATEDELAY_RIGHT,
        SA_PERI_GATELENGTH_LEFT,
        SA_PERI_GATELENGTH_RIGHT
    };
    enum{
