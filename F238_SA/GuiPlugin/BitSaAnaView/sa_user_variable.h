...
public://***************Related with Measure
    ...
    qreal   gOccupied_BW;//%
    qreal   gXdB;//dB
    qint64 gChannelBandwidth;    // Channel Power의 Channel BandWidth
    qint64 gChannelSpacing;    // SA_ACP 의 Channel Spacing
    ...
    quint64 uXdBBW;//Hz
    qreal   dPSD;// dBm/Hz
    qreal dLowest_MainCh_Power,dLowest_ADJCh_Power,dLowest_ALTCh_Power,dHighest_MainCh_Power,dHighest_ADJCh_Power,dHighest_ALTCh_Power;

    //Johnson 200225
    qint64 gHighestCHFreq;
    qint64 gLowestCHFreq;
    qint64 gMultiACPSpacing;
    qint64 gMainIntegBW;
    qint64 gADJIntegBW;
    qint64 gALTIntegBW;
    ...
    qint32 gSpecEMTestResult[2*SA_SPECEM_FREQ_CNT];
    qint32 gSpecEMMaskType;  // [0 -- 1.8 GHz  1 -- 5GNR Category A]
    qreal  gSpecEMRefChBw;
    qreal  gSpecEMBsPower; //31.01--38.00 dBm
    quint32 gSpecEMRefRbw;
...
public://***************Related with Sweep
    ...
    qreal   gSweepTime;
    qint32 gTriggerMode;  // [0] FreeRun  [1] Rise  [2] Fall  [3] Delay
#if 0
    quint32 gSweepSpeed;
#endif
...
public://***************Related with Trace
    ...
    qint32  gTraceTypeChangeStatus[NUM_TRACE]; // Trace Type status
    ...
    //quint32 gTmpDetectorMode[MARKER_TOTAL_CNT];//Johnson 1128 used to save the DetectorMode when marker noise is changed to SA_ON
    ...
    qreal   gTraceTempVal[NUM_SWEEP_POINT];
public://***************Related with Freq/Span
    qint64 gStartFreq; 	// Hz Unit
    qint64 gStopFreq; 	// Hz Unit
    qint64 gCenterFreq; 	// Hz Unit
    qint64 gCFFreq;   	// Hz Unit  use as freqstep to increase and decrease the centerfreq
    qint64 gSpanFreq; 	// Hz Unit
    qint64  gfreqOffset;
...
public://***************Related with Marker
    ...
    qint64 gMarkerRefFreq[MARKER_TOTAL_CNT];    // 각 Marker Ref Freq
    qint32  gMarkerRefPos[MARKER_TOTAL_CNT];
    qint64 gMarkerDeltaFreq[MARKER_TOTAL_CNT];    // 각 Marker Delta Freq
    ...
    qint32 gMarkerFreqCount;

    //Johnson 20200826
    qreal gMarkerCompensation;
...
public:
    ...
    void markerEditInNputMarkerPosCalculatorFunc(qint64 freq, qint32 inputType);
...
public:
    ...
    qint32 MultiACP_Highest_MainCh_x;
    qint32 MultiACP_Highest_ADJCh_x;
    qint32 MultiACP_Highest_ALTCh_x;
    qint32 MultiACP_Lowest_MainCh_x;
    qint32 MultiACP_Lowest_ADJCh_x;
    qint32 MultiACP_Lowest_ALTCh_x;
    qint32 MultiACP_MainCh_w;
    qint32 MultiACP_ADJCh_w;
    qint32 MultiACP_ALTCh_w;

    qint32 ACP_MainCH_x;
    qint32 ACP_LeftADJCH_x;
    qint32 ACP_LeftALTCH_x;
    qint32 ACP_RightADJCH_x;
    qint32 ACP_RightALTCH_x;
    qint32 ACP_MainCH_W;
    qint32 ACP_ADJCH_W;
    qint32 ACP_ALTCH_W;
    ...
    void setRelativeCPParam();
    void setRelativeOBWParam();
    void setRelativeACPParam();
    void setRelativeMultiACPParam();
    void initMeasurModeParam(qint32 curMod);
