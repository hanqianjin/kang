...
"font-weight:bold;"));
    ...
    {
        SA_Dialog_Error->setWindowTitle(QApplication::translate("SA_Dialog_Error", "Dialog", 0));
        Title->setText(QApplication::translate("SA_Dialog_Error", "Notice", 0));
        Warning->setText(QApplication::translate("SA_Dialog_Error", "Are you sure to clean all?\n"
"okok", 0));
        label->setText(QString());
        pb_ok->setText(QApplication::translate("SA_Dialog_Error", "OK", 0));
    } // retranslateUi
