...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_controlInterface_t, stringdata) + ofs \
...
QT_MOC_LITERAL(9, 109, 23),
QT_MOC_LITERAL(10, 133, 22),
QT_MOC_LITERAL(11, 156, 23)
    },
...
const QMetaObject controlInterface::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_controlInterface.data,
      qt_meta_data_controlInterface,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_controlInterface.stringdata))
