...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_sa_controlWidget_ChnlTable_t, stringdata) + ofs \
...
const QMetaObject sa_controlWidget_ChnlTable::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_sa_controlWidget_ChnlTable.data,
      qt_meta_data_sa_controlWidget_ChnlTable,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_sa_controlWidget_ChnlTable.stringdata))
        return static_cast<void*>(const_cast< sa_controlWidget_ChnlTable*>(this));
