...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SA_Dialog_CH_Std_t, stringdata) + ofs \
...
QT_MOC_LITERAL(9, 133, 13),
QT_MOC_LITERAL(10, 147, 11),
QT_MOC_LITERAL(11, 159, 14),
QT_MOC_LITERAL(12, 174, 19),
QT_MOC_LITERAL(13, 194, 16)
    },
...
const QMetaObject SA_Dialog_CH_Std::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SA_Dialog_CH_Std.data,
      qt_meta_data_SA_Dialog_CH_Std,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SA_Dialog_CH_Std.stringdata))
        return static_cast<void*>(const_cast< SA_Dialog_CH_Std*>(this));
