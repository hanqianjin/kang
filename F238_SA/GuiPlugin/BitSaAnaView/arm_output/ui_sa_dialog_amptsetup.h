...
"}"));
    ...
    {
        SA_Dialog_AmptSetup->setWindowTitle(QApplication::translate("SA_Dialog_AmptSetup", "Form", 0));
        SA_Dialog_AmptSetup->setProperty("status", QVariant(QApplication::translate("SA_Dialog_AmptSetup", "night", 0)));
        pb_Scale_Auto->setText(QApplication::translate("SA_Dialog_AmptSetup", "Auto Scale", 0));
...
"Offset", 0));
        label_4->setText(QApplication::translate("SA_Dialog_AmptSetup", "Scale / Div", 0));
        lblAtten->setText(QApplication::translate("SA_Dialog_AmptSetup", "Attenuation", 0));
        lblUnit->setText(QApplication::translate("SA_Dialog_AmptSetup", "Scale Unit", 0));
        lblPreamp->setText(QApplication::translate("SA_Dialog_AmptSetup", "Preamp", 0));
        pb_Preamp->setText(QApplication::translate("SA_Dialog_AmptSetup", "On", 0));
        pb_cancel->setText(QString());
        lblTitle->setText(QApplication::translate("SA_Dialog_AmptSetup", "Amplitude", 0));
        pb_unitSelect->clear();
        pb_unitSelect->insertItems(0, QStringList()
         << QApplication::translate("SA_Dialog_AmptSetup", "dBm", 0)
         << QApplication::translate("SA_Dialog_AmptSetup", "dBV", 0)
         << QApplication::translate("SA_Dialog_AmptSetup", "dBmV", 0)
         << QApplication::translate("SA_Dialog_AmptSetup", "dBuV", 0)
         << QApplication::translate("SA_Dialog_AmptSetup", "V", 0)
         << QApplication::translate("SA_Dialog_AmptSetup", "W", 0)
        );
        pb_Manual->setText(QApplication::translate("SA_Dialog_AmptSetup", "Manual", 0));
        pb_Auto->setText(QApplication::translate("SA_Dialog_AmptSetup", "Auto", 0));
        label_5->setText(QApplication::translate("SA_Dialog_AmptSetup", "Atten", 0));
        label_6->setText(QApplication::translate("SA_Dialog_AmptSetup", "Phase", 0));
    } // retranslateUi
