...
"}"));
    ...
    {
        SA_Dialog_TraceSetup->setWindowTitle(QApplication::translate("SA_Dialog_TraceSetup", "Form", 0));
        SA_Dialog_TraceSetup->setProperty("status", QVariant(QApplication::translate("SA_Dialog_TraceSetup", "night", 0)));
        pb_cancel->setText(QString());
        lblTitle->setText(QApplication::translate("SA_Dialog_TraceSetup", "Trace  ", 0));
        lblTraceType->setText(QApplication::translate("SA_Dialog_TraceSetup", "Trace\n"
"Type", 0));
        lblDete->setText(QApplication::translate("SA_Dialog_TraceSetup", "Detector", 0));
        TR_Type->clear();
        TR_Type->insertItems(0, QStringList()
         << QApplication::translate("SA_Dialog_TraceSetup", "Clear Write", 0)
         << QApplication::translate("SA_Dialog_TraceSetup", "Max Hold", 0)
         << QApplication::translate("SA_Dialog_TraceSetup", "Min Hold", 0)
         << QApplication::translate("SA_Dialog_TraceSetup", "View", 0)
         << QApplication::translate("SA_Dialog_TraceSetup", "Average", 0)
        );
        pb_toggle->setText(QApplication::translate("SA_Dialog_TraceSetup", "On", 0));
        lblTrace->setText(QApplication::translate("SA_Dialog_TraceSetup", "Trace", 0));
        pb_T1->setText(QApplication::translate("SA_Dialog_TraceSetup", "T1", 0));
        pb_T2->setText(QApplication::translate("SA_Dialog_TraceSetup", "T2", 0));
        pb_T3->setText(QApplication::translate("SA_Dialog_TraceSetup", "T3", 0));
        pb_T5->setText(QApplication::translate("SA_Dialog_TraceSetup", "T5", 0));
        pb_T4->setText(QApplication::translate("SA_Dialog_TraceSetup", "T4", 0));
        pb_T6->setText(QApplication::translate("SA_Dialog_TraceSetup", "T6", 0));
        TR_Detector->clear();
        TR_Detector->insertItems(0, QStringList()
         << QApplication::translate("SA_Dialog_TraceSetup", "Auto", 0)
         << QApplication::translate("SA_Dialog_TraceSetup", "Positive Peak", 0)
         << QApplication::translate("SA_Dialog_TraceSetup", "Negative Peak", 0)
         << QApplication::translate("SA_Dialog_TraceSetup", "Sample", 0)
         << QApplication::translate("SA_Dialog_TraceSetup", "Normal", 0)
         << QApplication::translate("SA_Dialog_TraceSetup", "Average Voltage", 0)
         << QApplication::translate("SA_Dialog_TraceSetup", "RMS", 0)
        );
        lblAveCount->setText(QApplication::translate("SA_Dialog_TraceSetup", "Average\n"
"Count", 0));
        averageEdit->setText(QString());
        lblTraceView->setText(QApplication::translate("SA_Dialog_TraceSetup", "Trace View", 0));
        pb_clearall->setText(QApplication::translate("SA_Dialog_TraceSetup", "Trace Clear All", 0));
        pb_traceAllOn->setText(QApplication::translate("SA_Dialog_TraceSetup", "Trace  All On", 0));
        pb_toggle_Ave->setText(QApplication::translate("SA_Dialog_TraceSetup", "On", 0));
        lblAveToggle->setText(QApplication::translate("SA_Dialog_TraceSetup", "Average", 0));
    } // retranslateUi
