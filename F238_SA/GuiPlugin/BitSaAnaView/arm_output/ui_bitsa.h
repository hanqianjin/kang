...
""));
    ...
    {
        BitSA->setWindowTitle(QApplication::translate("BitSA", "Form", 0));
        BitSA->setProperty("status", QVariant(QApplication::translate("BitSA", "outdoor", 0)));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("BitSA", "Frequency(MHz)", 0));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("BitSA", "Amplitude(dBm)", 0));
        topButton5->setText(QApplication::translate("BitSA", "Trigger", 0));
        topButton8->setText(QApplication::translate("BitSA", "Limit", 0));
        topButton7->setText(QApplication::translate("BitSA", "Marker", 0));
        topButton1->setText(QApplication::translate("BitSA", "Frequency", 0));
        topButton6->setText(QApplication::translate("BitSA", "Trace", 0));
        topButton2->setText(QApplication::translate("BitSA", "Amplitude", 0));
        topButton3->setText(QApplication::translate("BitSA", "Sweep", 0));
        topButton4->setText(QApplication::translate("BitSA", "Bandwidth", 0));
        topButton9->setText(QApplication::translate("BitSA", "Measure", 0));
        ...
        buttomMarker->setProperty("check", QVariant(QApplication::translate("BitSA", "true", 0)));
        pb_marker_AllOff->setText(QApplication::translate("BitSA", "Clear All", 0));
        pb_marker_1->setText(QString());
        pb_marker_1->setProperty("mode", QVariant(QApplication::translate("BitSA", "1", 0)));
        pb_marker_2->setText(QString());
        pb_marker_2->setProperty("mode", QVariant(QApplication::translate("BitSA", "1", 0)));
        pb_marker_3->setText(QString());
        pb_marker_3->setProperty("mode", QVariant(QApplication::translate("BitSA", "1", 0)));
        pb_marker_4->setText(QString());
        pb_marker_4->setProperty("mode", QVariant(QApplication::translate("BitSA", "1", 0)));
        pb_marker_5->setText(QString());
        pb_marker_5->setProperty("mode", QVariant(QApplication::translate("BitSA", "1", 0)));
        pb_marker_6->setText(QString());
        pb_marker_6->setProperty("mode", QVariant(QApplication::translate("BitSA", "1", 0)));
#ifndef QT_NO_WHATSTHIS
        leftInfoWidget->setWhatsThis(QString());
#endif // QT_NO_WHATSTHIS
        lblmeasure->setText(QApplication::translate("BitSA", "> Occupied BW", 0));
        lblmode->setText(QApplication::translate("BitSA", "Spectrum Analyzer", 0));
        lblmodetitle->setText(QApplication::translate("BitSA", "Mode", 0));
        lblCenterFreq->setText(QApplication::translate("BitSA", "Center Freq", 0));
        lblChannel->setText(QApplication::translate("BitSA", "Channel", 0));
        lblCHStandard->setText(QApplication::translate("BitSA", "CH Standard", 0));
        lblCenterFreqValue->setText(QApplication::translate("BitSA", "1.000 000 000 GHz", 0));
        lblChannelValue->setText(QApplication::translate("BitSA", "----", 0));
        lblCHStandardValue->setText(QApplication::translate("BitSA", "Band 0 (800)", 0));
        lblOffset->setText(QApplication::translate("BitSA", "External Offset", 0));
        lblAtten->setText(QApplication::translate("BitSA", "Attenuation", 0));
        lblPreamp->setText(QApplication::translate("BitSA", "Preamp", 0));
        lblAttenType->setText(QApplication::translate("BitSA", "Couple", 0));
        lblAttenValue->setText(QApplication::translate("BitSA", "20 dB", 0));
        lblOffsetValue->setText(QApplication::translate("BitSA", "0.00 dB", 0));
        lblOffsetType->setText(QApplication::translate("BitSA", "On", 0));
        lblPreampValue->setText(QApplication::translate("BitSA", "Off", 0));
        lblAverage->setText(QApplication::translate("BitSA", "Average", 0));
        lblVBW->setText(QApplication::translate("BitSA", "VBW", 0));
        lblRBW->setText(QApplication::translate("BitSA", "RBW", 0));
        lblRBWType->setText(QApplication::translate("BitSA", "Auto", 0));
        lblVBWType->setText(QApplication::translate("BitSA", "Auto", 0));
        lblAverageValue->setText(QApplication::translate("BitSA", "1/1", 0));
        lblVBWValue->setText(QApplication::translate("BitSA", "100 kHz", 0));
        lblRBWValue->setText(QApplication::translate("BitSA", "100 kHz", 0));
        lblAveOn->setText(QApplication::translate("BitSA", "On", 0));
        lblDetectors->setText(QApplication::translate("BitSA", "Detector", 0));
        label_25->setText(QApplication::translate("BitSA", "Sweep Time", 0));
        lblSweepTime->setText(QApplication::translate("BitSA", "50 ms", 0));
        label_27->setText(QApplication::translate("BitSA", "Sweep Mode", 0));
        lblSweepMode->setText(QApplication::translate("BitSA", "Continuous", 0));
        lblDetectorValue->setText(QApplication::translate("BitSA", "Sample", 0));
        lblIFOutPut->setText(QApplication::translate("BitSA", "IF OutPut", 0));
        label_31->setText(QApplication::translate("BitSA", "Trigger Source", 0));
        lblIFOutPutValue->setText(QApplication::translate("BitSA", "Internal", 0));
        label_33->setText(QApplication::translate("BitSA", "Freq Reference", 0));
        lblFreqRef->setText(QApplication::translate("BitSA", "Internal", 0));
        lblTrigger->setText(QApplication::translate("BitSA", "Free Run", 0));
        lblT2->setText(QApplication::translate("BitSA", "T2", 0));
        lblT3->setText(QApplication::translate("BitSA", "T3", 0));
        lblT4->setText(QApplication::translate("BitSA", "T4", 0));
        lblT5->setText(QApplication::translate("BitSA", "T5", 0));
        lblT6->setText(QApplication::translate("BitSA", "T6", 0));
        ...
        lblT1->setText(QApplication::translate("BitSA", "T1", 0));
        ...
        lblLimit->setText(QApplication::translate("BitSA", "Limit", 0));
        lblLimitStatus->setText(QApplication::translate("BitSA", "Off", 0));
