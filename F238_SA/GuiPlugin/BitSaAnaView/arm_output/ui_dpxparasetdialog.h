...
public:
    ...
    {
        DPXParaSetDialog->setWindowTitle(QApplication::translate("DPXParaSetDialog", "Dialog", 0));
        label->setText(QApplication::translate("DPXParaSetDialog", "DPX Enable:", 0));
        dpxEnablecomboBox->setCurrentText(QString());
        persistenceModecomboBox->setCurrentText(QString());
        label_2->setText(QApplication::translate("DPXParaSetDialog", "Persistence Mode:", 0));
        bitmapExtraccomboBox->setCurrentText(QString());
        label_3->setText(QApplication::translate("DPXParaSetDialog", "Bitmap Clear:", 0));
        bitmapCtrlcomboBox->setCurrentText(QString());
        label_4->setText(QApplication::translate("DPXParaSetDialog", "Bitmap Extrac:", 0));
        label_5->setText(QApplication::translate("DPXParaSetDialog", "Highest Density:", 0));
        label_6->setText(QApplication::translate("DPXParaSetDialog", "Lowest Density:", 0));
        label_7->setText(QApplication::translate("DPXParaSetDialog", "Persistence Time:", 0));
        label_8->setText(QApplication::translate("DPXParaSetDialog", "Acquire Time:", 0));
        label_9->setText(QApplication::translate("DPXParaSetDialog", "s", 0));
        label_10->setText(QApplication::translate("DPXParaSetDialog", "s", 0));
        OKbutton->setText(QApplication::translate("DPXParaSetDialog", "OK", 0));
        Cancelbutton->setText(QApplication::translate("DPXParaSetDialog", "Cancel", 0));
        label_11->setText(QApplication::translate("DPXParaSetDialog", "%", 0));
        label_12->setText(QApplication::translate("DPXParaSetDialog", "%", 0));
    } // retranslateUi
