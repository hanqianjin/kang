...
#define SAMPLE_LIMIT    //upper and lower limit control for channel power,acp and more
//#define SA_MULTI_TOUCH  //multi touch control

// SMARFAT
//#define SA_F238_SMART
//#define SA_F238
#define SA_F239

//#define SA_SEG_CHANGE_NEW //span <= SA_SEG_CHANGE_MINSPAN not disperate into 2 seg.
//#define SA_SEG_START_STOP_NEW //span <= SA_SEG_CHANGE_MINSPAN not disperate into 2 seg.
#define SA_SEG_CHANGE_MINSPAN 20000000.0        //不分段的最小扫宽 20MHz
#define SA_SEG_START_STOP_EXTENSION 100000.0    //起始/终止频率不分段的范围 100kHz


#include <QObject>

//Johnson 200217
//variable used to precompile
#define AFTERGATESWEEPCHANGED 1
#define GUIDRAW_CONFIG 0
#define NEW_FORMULA 1
#define SPUREMODIFY 1
#define EXCHANGE_ACPMULTIACP 1
#define ADD_5MVBW 1
#define HIDE_MULTIACP 0
...
#ifdef SA_F238_SMART
#define SPEC_FREQ_MIN  0LL // 0kHz
#define SPEC_FREQ_MAX  15050000000LL // 43.05GHz
#endif
...
#define SPEC_AMPTD_MAX  30.   // 30 dBm
...
#define FDD_B1_UP_FREQ_MIN 1920000000LL
#define FDD_B1_UP_FREQ_MAX 1979900000LL
#define FDD_B1_DOWN_FREQ_MIN 2110000000LL
#define FDD_B1_DOWN_FREQ_MAX 2169900000LL
#define FDD_B3_UP_FREQ_MIN 1710000000LL
#define FDD_B3_UP_FREQ_MAX 1784900000LL
#define FDD_B3_DOWN_FREQ_MIN 1805000000LL
#define FDD_B3_DOWN_FREQ_MAX 1879900000LL
...
#define TD_B38_FREQ_MIN 2570000000LL
#define TD_B38_FREQ_MAX 2619900000LL
#define TD_B39_FREQ_MIN 1880000000LL
#define TD_B39_FREQ_MAX 1919900000LL
#define TD_B40_FREQ_MIN 2300000000LL
#define TD_B40_FREQ_MAX 2399900000LL
#define TD_B41_FREQ_MIN 2496000000LL
#define TD_B41_FREQ_MAX 2689900000LL
...
#define SPEC_EM_5GNR_CENT_OFFSET_1 (50.05 / 380 * NUM_SWEEP_POINT)
#define SPEC_EM_5GNR_CENT_OFFSET_2 (55.05 / 380 * NUM_SWEEP_POINT)
#define SPEC_EM_5GNR_CENT_OFFSET_3 (60.05 /380 * NUM_SWEEP_POINT)
...
enum {
    ...
    SA_INPUT_UPPER_LIMIT_AMPT,
    SA_INPUT_LOWER_LIMIT_AMPT,
    SA_INPUT_ATLDBC_LIMIT_AMP,

    SA_INPUT_SEM_CHBW,
    SA_INPUT_SEM_BSPOWER,

    //Johnson 20200225
    SA_INPUT_MULTIACP_HIGHESTCH_FREQ,
    SA_INPUT_MULTIACP_LOWESTCH_FREQ,
    SA_INPUT_MULTIACP_CHNLSPACING,
    SA_INPUT_MULTIACP_MAININTEG_BW,
    SA_INPUT_MULTIACP_ADJINTEG_BW,
    SA_INPUT_MULTIACP_ALTINTEG_BW,
};
enum{
  SA_COMBOBOX_ATTEN = -1,
  SA_COMBOBOX_UNIT = -2,
  ...
  SA_COMBOBOX_SEM_MASK = -11,
  SA_COMBOBOX_SEM_DISPLAY = -12,
  SA_COMBOBOX_SEM_REF = -13,
};
// Sweep - Detector
enum {
    /*MAX                       = 0,
...
//Johnson 200120
enum{
    SA_GATEDLY_MOUSE_ACTION,
    SA_GATELEN_MOUSE_ACTION,
};
...
#define SA_ATL_DBC_LIMIT          45.
#define SA_OBW_LIMIT              500000
...
#define DRAW_AMPTD_LBL_START_X    30//
...
#if EXCHANGE_ACPMULTIACP
#define ACP_MARKERTABLE_SHOW_CENTERAREA_HEIGHT          463
#define ACP_MARKERTABLE_HIDE_CENTERAREA_HEIGHT          523
#else
...
#define SA_SPECEM_FREQ_CNT_5GNR 3
...
{
    {15000,215000,30000,3000,-14,-14,99,99},
    {215000,1015000,30000,3000,-14,-26,99,99},
    {1015000,1500000,30000,3000,-26,-26,99,99},
    {1500000,5500000,1000000,100000,-13,-13,99,99},
    {5500000,10000000,1000000,100000,-13,-13,99,99},
    {10000000,12500000,1000000,100000,-13,-13,99,99},
};

static const __SPEC_EM__ mSpecEM_5GNR_CategoryA[SA_SPECEM_FREQ_CNT]=
{
    {50000,5050000,100000,10000,-5.2,-12.2,99,99},
    {5050000,10050000,100000,10000,-12.2,-12.2,99,99},
    {10050000,140000000,1000000,100000,-13,-13,99,99},
};

static const __SPEC_EM__ mSpecEM_5GNR_CategoryB[SA_SPECEM_FREQ_CNT]=
{
    {50000,5050000,100000,10000,-5.2,-12.2,99,99},
    {5050000,10050000,100000,10000,-12.2,-12.2,99,99},
    {10050000,140000000,1000000,100000,-13,-13,99,99},
...
static const __SPEC_EM__ mSpecEM_5GNR_P31_38[SA_SPECEM_FREQ_CNT]=
{
    {50000,5050000,100000,10000,-5.2,-12.2,99,99},
    {5050000,10050000,100000,10000,-12.2,-12.2,99,99},
    {10050000,140000000,100000,10000,-13,-13,99,99},
};

static const __SPEC_EM__ mSpecEM_5GNR_P31[SA_SPECEM_FREQ_CNT]=
{
    {50000,5050000,100000,10000,-5.2,-12.2,99,99},
    {5050000,10050000,100000,10000,-12.2,-12.2,99,99},
    {10050000,140000000,100000,10000,-13,-13,99,99},
...
{
    #if SPUREMODIFY
    {1,9000,150000,1000,1000,-36,-36},
    {2,150000,30000000,10000,10000,-36,-36},
    {3,30000000,1000000000LL,100000,100000,-36,-36},
    {4,1000000000LL,12750000000LL,1000000,1000000,-30,-30},
    {5,12750000000LL,15000000000LL,1000000,1000000,-30,-30},
    {6,800000000,1000000000,1000000,1000000,-50,-50},
    {7,800000000,1000000000,1000000,1000000,-50,-50},
    {8,800000000,1000000000,1000000,1000000,-50,-50},
    {9,800000000,1000000000,1000000,1000000,-50,-50},
    {10,800000000,1000000000,1000000,1000000,-50,-50},
    {11,800000000,1000000000,1000000,1000000,-50,-50},
    {12,800000000,1000000000,1000000,1000000,-50,-50},
    {13,800000000,1000000000,1000000,1000000,-50,-50},
    {14,800000000,1000000000,1000000,1000000,-50,-50},
    {15,800000000,1000000000,1000000,1000000,-50,-50},
    {16,800000000,1000000000,1000000,1000000,-50,-50},
    {17,800000000,1000000000,1000000,1000000,-50,-50},
    {18,800000000,1000000000,1000000,1000000,-50,-50},
    {19,800000000,1000000000,1000000,1000000,-50,-50},
    {20,800000000,1000000000,1000000,1000000,-50,-50},
    #else
    ...
    {4,2175000000LL,2180000000LL,30000,30000,297.34,-50,-50,6,-90,10},
...
static const char* qssMode[3] = {"indoor","outdoor","night"};
...
enum{
    SA_SPECEM_DEFAULT = 0,
    SA_SPECEM_5GNR_CATEGORYA, // Category A
    SA_SPECEM_5GNR_CATEGORYB, // Category B
    SA_SPECEM_5GNR_P31_38, //BS  P >31 dBm P<38
    SA_SPECEM_5GNR_P31  // BS p < 31 dBm
};
/************************************************************/
...
//Johnson 20200110
#define PHASE_RATIO 5.625

#define ATTENMAX_WITHINITIAL  65535
#define ATTENMIN_WITHINITIAL  500
#define ATTENSTEP_WITHINITIAL 500

#define PHASEMAX_WITHINITIAL  63
#define PHASEMIN_WITHINITIAL  10
