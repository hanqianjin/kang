...
public:
    ...
    void limitXAxisCalculatorFunc(qint64 Freq, qint32 index, qint32 uLimitSelect);//caculate the x axis of every point
    ...
    qint32 gUpperLimitTestResult;
    qint32 gLowerLimitTestResult;
    qreal gATLdBcLimit;
    qint32 gATLdBcLimitStatus;
    qint32 gATLdBcLimitTestResult;
#endif
};
#endif // USER_LIMIT
