...
"color: rgb(255, 255, 255);"));
    ...
    {
        BitPlatForm->setWindowTitle(QApplication::translate("BitPlatForm", "BitPlatForm", 0));
        ...
        gpslabel->setText(QApplication::translate("BitPlatForm", "-- -- -- --", 0));
        plusbtn->setText(QString());
        label_4->setText(QString());
        label_6->setText(QApplication::translate("BitPlatForm", "Real-Time SA<BR/><span style=\"font-weight:normal;\">Persist Spectrogram</span>", 0));
        label_7->setText(QApplication::translate("BitPlatForm", "LTE-A FDD<BR/><span style=\"font-weight:normal;\">Power vs Time(Slot)</span>", 0));
        label_8->setText(QApplication::translate("BitPlatForm", "Power Meter<BR/><span style=\"font-weight:normal;\">Internal</span>", 0));
