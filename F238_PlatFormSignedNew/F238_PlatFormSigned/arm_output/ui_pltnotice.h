...
"QPushButton{border: none;}"));
    ...
    {
        pltnotice->setWindowTitle(QApplication::translate("pltnotice", "Dialog", 0));
        pltnotice->setProperty("pltdismode", QVariant(QApplication::translate("pltnotice", "indoor", 0)));
        pushButtoncancel->setText(QApplication::translate("pltnotice", "Cancel", 0));
        Warning->setText(QApplication::translate("pltnotice", "Are you sure to save current state to \342\200\234User\342\200\235?", 0));
        Title->setText(QApplication::translate("pltnotice", "Notice", 0));
        label->setText(QString());
        pushButtonok->setText(QApplication::translate("pltnotice", "OK", 0));
        label_2->setText(QApplication::translate("pltnotice", "Password failed!", 0));
        lineEdit->setText(QApplication::translate("pltnotice", "123456", 0));
