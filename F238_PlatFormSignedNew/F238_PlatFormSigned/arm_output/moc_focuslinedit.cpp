...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_focuslinedit_t, stringdata) + ofs \
...
const QMetaObject focuslinedit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_focuslinedit.data,
      qt_meta_data_focuslinedit,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_focuslinedit.stringdata))
        return static_cast<void*>(const_cast< focuslinedit*>(this));
