...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_plusmode_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 94, 17),
QT_MOC_LITERAL(8, 112, 21),
QT_MOC_LITERAL(9, 134, 21),
QT_MOC_LITERAL(10, 156, 19),
QT_MOC_LITERAL(11, 176, 24),
QT_MOC_LITERAL(12, 201, 24),
QT_MOC_LITERAL(13, 226, 24)
    },
...
const QMetaObject plusmode::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_plusmode.data,
      qt_meta_data_plusmode,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_plusmode.stringdata))
        return static_cast<void*>(const_cast< plusmode*>(this));
