...
""));
    ...
    {
        WifiConnect->setWindowTitle(QApplication::translate("WifiConnect", "Dialog", 0));
        WifiConnect->setProperty("pltdismode", QVariant(QApplication::translate("WifiConnect", "indoor", 0)));
        lblTitle->setText(QApplication::translate("WifiConnect", "Please enter password", 0));
        lblnotice->setText(QApplication::translate("WifiConnect", "Wi-fi network \342\200\234 ******* \342\200\235 need to enter password.", 0));
        label->setText(QString());
        lblPassWord->setText(QApplication::translate("WifiConnect", "Password", 0));
        passWordEdit->setInputMask(QString());
        passWordEdit->setText(QString());
        pb_pair->setText(QApplication::translate("WifiConnect", "OK", 0));
        pb_cancel->setText(QApplication::translate("WifiConnect", "Cancel", 0));
        lblWarning->setText(QApplication::translate("WifiConnect", "Connection error, please reconnect.", 0));
