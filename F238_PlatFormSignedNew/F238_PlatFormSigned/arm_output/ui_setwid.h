...
"}"));
    ...
    {
        setwid->setWindowTitle(QApplication::translate("setwid", "Form", 0));
        setwid->setProperty("pltdismode", QVariant(QApplication::translate("setwid", "indoor", 0)));
        label->setText(QString());
        clobtn->setText(QString());
        label_2->setText(QApplication::translate("setwid", "Settings", 0));
        pushButton_4->setText(QApplication::translate("setwid", "Self Test", 0));
        pushButton->setText(QApplication::translate("setwid", "General Setting", 0));
        pushButton_3->setText(QApplication::translate("setwid", "Network Setting", 0));
        label_3->setText(QApplication::translate("setwid", "Items", 0));
        pushButton_2->setText(QApplication::translate("setwid", "Display / Sound / Date / Time", 0));
        pushButton_5->setText(QApplication::translate("setwid", "Calibration", 0));
        pushButton_6->setText(QApplication::translate("setwid", "System Information", 0));
    } // retranslateUi
