...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_pltnotice_t, stringdata) + ofs \
...
const QMetaObject pltnotice::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_pltnotice.data,
      qt_meta_data_pltnotice,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pltnotice.stringdata))
        return static_cast<void*>(const_cast< pltnotice*>(this));
