...
private:
  ...
  //here change xx.xxxx° to xx°xx'xx'' add by albert
...
private slots:
  void on_wifiCilcked(qint32 wifiId);
  ...
  void on_USBtest(QString wSpeed,QString rSpeed);
  void on_usbTest_clicked(bool checked);
  void on_USBstatus(qint32 status);
#endif
private:
