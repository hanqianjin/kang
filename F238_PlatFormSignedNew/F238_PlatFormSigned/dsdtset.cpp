  ...
  ui(new Ui::dsdtset)
{
  ...
  ui->keybeepbtn->setVisible(false);
  ui->label_9->setVisible(true);
  ui->line_9->setVisible(true);
  ui->soundswithbtn->setVisible(true);
...
/**
 * @brief dsdtset::initDSDTObj
 * @param obj
 * @author Johnson
 */
void dsdtset::initDSDTObj(PLT_DSDT &obj)
{
    obj.datetype = new qint32();
    obj.dismod = new qint32();
    obj.keybeepswitch = new qint32();
    obj.lcdbri = new qint32();
    obj.slemod = new qint32();
    obj.soundnum = new qint32();
    obj.soundswitch = new qint32();
}
...
void dsdtset::ReStartSysSleep()
{
  //open lcd brightness
  shmengine::getsingleshm()->pshm_sysconf->LcdpadLight = PTY1;
  shmengine::PassTrigToSys(PLT_IXT_ConfigSystem,PLT_IXS_LcdpadLight | PLT_IXS_KeyBeep);
  //retimer
  if(timerswitch)
    {
      if(sleeptimerid)
...
void dsdtset::on_pushButton_clicked()
{
    ui->DateEdit->clear();
}

void dsdtset::on_pushButton_2_clicked()
{
    ui->TimeEdit->clear();
}
