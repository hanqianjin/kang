...
void debugdia::on_pushButton_3_clicked()
{
  debugmsgH->secifatten = ui->spinBox_2->value();
  shmengine::getsingleshm()->pshm_sysconf->secifatten = ui->spinBox_2->value();
  shmengine::PassTrigToSys(PLT_IXT_ConfigSystem,PLT_IXS_SecIfAtten);
}
...
void debugdia::RefleshStates(PDEVEMSG pHandle)
{
  ...
  this->ui->spinBox_2->setValue(debugmsgH->secifatten);
}
...
void debugdia::on_pushButton_4_clicked()
{
    system("rm /app/*.log");
}
