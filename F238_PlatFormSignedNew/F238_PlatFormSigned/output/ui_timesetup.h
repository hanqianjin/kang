...
"}"));
    ...
    {
        timeSetup->setWindowTitle(QApplication::translate("timeSetup", "Dialog", Q_NULLPTR));
        timeSetup->setProperty("pltdismode", QVariant(QApplication::translate("timeSetup", "indoor", Q_NULLPTR)));
        ...
        pb_cancel->setText(QApplication::translate("timeSetup", "Cancel", Q_NULLPTR));
        pb_ok->setText(QApplication::translate("timeSetup", "OK", Q_NULLPTR));
    } // retranslateUi
