...
public:
    ...
    {
        switmod->setWindowTitle(QApplication::translate("switmod", "Form", Q_NULLPTR));
        label_4->setText(QApplication::translate("switmod", "Changing Mode \342\200\246", Q_NULLPTR));
    } // retranslateUi
