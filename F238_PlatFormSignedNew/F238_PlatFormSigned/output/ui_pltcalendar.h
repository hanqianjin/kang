...
"}"));
    ...
    {
        pltCalendar->setWindowTitle(QApplication::translate("pltCalendar", "Dialog", Q_NULLPTR));
        pltCalendar->setProperty("pltdismode", QVariant(QApplication::translate("pltCalendar", "indoor", Q_NULLPTR)));
        pb_cancel->setText(QApplication::translate("pltCalendar", "Cancel", Q_NULLPTR));
        pb_ok->setText(QApplication::translate("pltCalendar", "OK", Q_NULLPTR));
    } // retranslateUi
