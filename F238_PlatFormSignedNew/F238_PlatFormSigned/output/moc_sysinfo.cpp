...
struct qt_meta_stringdata_sysinfo_t {
    QByteArrayData data[1];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_sysinfo_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_sysinfo_t qt_meta_stringdata_sysinfo = {
    {
QT_MOC_LITERAL(0, 0, 7) // "sysinfo"
...
const QMetaObject sysinfo::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_sysinfo.data,
      qt_meta_data_sysinfo,  qt_static_metacall, nullptr, nullptr}
};
...
void *sysinfo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_sysinfo.stringdata0))
