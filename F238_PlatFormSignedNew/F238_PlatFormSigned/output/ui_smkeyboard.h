...
"}"));
    ...
    {
        SmKeyBoard->setWindowTitle(QApplication::translate("SmKeyBoard", "Form", Q_NULLPTR));
        SmKeyBoard->setProperty("pltdismode", QVariant(QApplication::translate("SmKeyBoard", "indoor", Q_NULLPTR)));
        lblTitle->setText(QApplication::translate("SmKeyBoard", "IP Address", Q_NULLPTR));
        pb_7->setText(QApplication::translate("SmKeyBoard", "7", Q_NULLPTR));
        pb_1->setText(QApplication::translate("SmKeyBoard", "1", Q_NULLPTR));
        pb_8->setText(QApplication::translate("SmKeyBoard", "8", Q_NULLPTR));
        pb_dot->setText(QApplication::translate("SmKeyBoard", ".", Q_NULLPTR));
        pb_add->setText(QString());
        pb_3->setText(QApplication::translate("SmKeyBoard", "3", Q_NULLPTR));
        pb_4->setText(QApplication::translate("SmKeyBoard", "4", Q_NULLPTR));
        pb_clear->setText(QString());
        pb_enter->setText(QApplication::translate("SmKeyBoard", "Enter", Q_NULLPTR));
        pb_2->setText(QApplication::translate("SmKeyBoard", "2", Q_NULLPTR));
        pb_del->setText(QString());
        pb_6->setText(QApplication::translate("SmKeyBoard", "6", Q_NULLPTR));
        pb_0->setText(QApplication::translate("SmKeyBoard", "0", Q_NULLPTR));
        pb_5->setText(QApplication::translate("SmKeyBoard", "5", Q_NULLPTR));
        pb_9->setText(QApplication::translate("SmKeyBoard", "9", Q_NULLPTR));
