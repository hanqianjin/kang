...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_setwid_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_setwid_t qt_meta_stringdata_setwid = {
    {
QT_MOC_LITERAL(0, 0, 6), // "setwid"
QT_MOC_LITERAL(1, 7, 17), // "on_clobtn_clicked"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 18), // "buttonGroupClicked"
QT_MOC_LITERAL(4, 45, 7), // "idIndex"
QT_MOC_LITERAL(5, 53, 9) // "DisToHide"
...
const QMetaObject setwid::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_setwid.data,
      qt_meta_data_setwid,  qt_static_metacall, nullptr, nullptr}
};
...
void *setwid::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_setwid.stringdata0))
