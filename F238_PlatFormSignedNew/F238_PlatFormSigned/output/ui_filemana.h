...
"}"));
    ...
    {
        filemana->setWindowTitle(QApplication::translate("filemana", "Form", Q_NULLPTR));
        filemana->setProperty("pltdismode", QVariant(QApplication::translate("filemana", "indoor", Q_NULLPTR)));
        label_4->setText(QApplication::translate("filemana", "Zero Frequency Adjust", Q_NULLPTR));
        pushButton_19->setText(QApplication::translate("filemana", "Zero Freq Auto Adjust", Q_NULLPTR));
        pushButton_21->setText(QApplication::translate("filemana", "Factory Debug", Q_NULLPTR));
        label_5->setText(QApplication::translate("filemana", "Factory Funtions Debug", Q_NULLPTR));
    } // retranslateUi
