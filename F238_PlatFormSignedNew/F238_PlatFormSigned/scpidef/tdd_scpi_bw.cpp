...
scpi_result_t TDD_BANDWIDTH_IFOutPut(scpi_t *context)
{
    ...
    remoteinterface::gettddremotehandle()->SCPI_ParamInt(LTE_SCPI_BW_IFOUTPUT, value);
    return SCPI_RES_OK;
}
...
scpi_result_t TDD_BANDWIDTH_IFOutPutQ(scpi_t *context)
{
    ...
    qint32 value;
    value = remoteinterface::gettddremotehandle()->SCPI_ResultInt(LTE_SCPI_BW_IFOUTPUT);
