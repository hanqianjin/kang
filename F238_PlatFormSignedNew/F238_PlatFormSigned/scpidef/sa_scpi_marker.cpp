...
scpi_result_t SA_MARKER_Compensation(scpi_t *context)
{
    double value;
    if (g_systemStatus.mode==Mode_local)
      return SCPI_RES_ERR;
    ...
    remoteinterface::getsaremotehandle()->pcontrolInterface->setMarkerRefAmpCompensation(value);
    return SCPI_RES_OK;
}
...
scpi_result_t SA_MARKER_YQ(scpi_t * context)
{
    qreal value;
    if (g_systemStatus.mode==Mode_local)
      return SCPI_RES_ERR;
    ...
    if(!mkrType)
    {
        value = remoteinterface::getsaremotehandle()->pcontrolInterface->getMarkerRefAmp();
    }else
    {
        value = remoteinterface::getsaremotehandle()->pcontrolInterface->getMarkerDeltaAmp();
    }
...
scpi_result_t SA_MARKER1_YQ(scpi_t * context)
{
    qreal value;
    if (g_systemStatus.mode==Mode_local)
      return SCPI_RES_ERR;
    ...
    if(!mkrType)
    {
        value = remoteinterface::getsaremotehandle()->pcontrolInterface->getMarkerRefAmp(0);
    }else
    {
        value = remoteinterface::getsaremotehandle()->pcontrolInterface->getMarkerDeltaAmp(0);
    }
...
scpi_result_t SA_MARKER2_YQ(scpi_t * context)
{
    qreal value;
    if (g_systemStatus.mode==Mode_local)
      return SCPI_RES_ERR;
    ...
    if(!mkrType)
    {
        value = remoteinterface::getsaremotehandle()->pcontrolInterface->getMarkerRefAmp(1);
    }else
    {
        value = remoteinterface::getsaremotehandle()->pcontrolInterface->getMarkerDeltaAmp(1);
    }
...
scpi_result_t SA_MARKER3_YQ(scpi_t * context)
{
    qreal value;
    if (g_systemStatus.mode==Mode_local)
      return SCPI_RES_ERR;
    ...
    if(!mkrType)
    {
        value = remoteinterface::getsaremotehandle()->pcontrolInterface->getMarkerRefAmp(2);
    }else
    {
        value = remoteinterface::getsaremotehandle()->pcontrolInterface->getMarkerDeltaAmp(2);
    }
...
scpi_result_t SA_MARKER4_YQ(scpi_t * context)
{
    qreal value;
    if (g_systemStatus.mode==Mode_local)
      return SCPI_RES_ERR;
    ...
    if(!mkrType)
    {
        value = remoteinterface::getsaremotehandle()->pcontrolInterface->getMarkerRefAmp(3);
    }else
    {
        value = remoteinterface::getsaremotehandle()->pcontrolInterface->getMarkerDeltaAmp(3);
    }
...
scpi_result_t SA_MARKER5_YQ(scpi_t * context)
{
    qreal value;
    if (g_systemStatus.mode==Mode_local)
      return SCPI_RES_ERR;
    ...
    if(!mkrType)
    {
        value = remoteinterface::getsaremotehandle()->pcontrolInterface->getMarkerRefAmp(4);
    }else
    {
        value = remoteinterface::getsaremotehandle()->pcontrolInterface->getMarkerDeltaAmp(4);
    }
...
scpi_result_t SA_MARKER6_YQ(scpi_t * context)
{
    qreal value;
    if (g_systemStatus.mode==Mode_local)
      return SCPI_RES_ERR;
    ...
    if(!mkrType)
    {
        value = remoteinterface::getsaremotehandle()->pcontrolInterface->getMarkerRefAmp(5);
    }else
    {
        value = remoteinterface::getsaremotehandle()->pcontrolInterface->getMarkerDeltaAmp(5);
    }
...
scpi_result_t SA_PEAkPOInt_FreqQ(scpi_t * context)
{
  qreal peakPointFreq;
  ...
  peakPointFreq = remoteinterface::getsaremotehandle()->pcontrolInterface->getPeakPointFreq();
  if(!SCPI_ResultDouble(context, peakPointFreq))
    {
      return SCPI_RES_ERR;
    }
  return SCPI_RES_OK;
...
scpi_result_t SA_PEAkPOInt_AmpQ(scpi_t * context)
{
  qreal peakPointAmp;
  ...
  peakPointAmp = remoteinterface::getsaremotehandle()->pcontrolInterface->getPeakPointAmpt();
  if(!SCPI_ResultDouble(context, peakPointAmp))
    {
      return SCPI_RES_ERR;
    }
  return SCPI_RES_OK;
