...
\
{"[:SENSe]:MARKer:Y?",  SA_MARKER_YQ}, /*{Double}*/\
{"[:SENSe]:MARKer:1:Y?",  SA_MARKER1_YQ}, /*{Double}*/\
{"[:SENSe]:MARKer:2:Y?",  SA_MARKER2_YQ}, /*{Double}*/\
{"[:SENSe]:MARKer:3:Y?",  SA_MARKER3_YQ}, /*{Double}*/\
{"[:SENSe]:MARKer:4:Y?",  SA_MARKER4_YQ}, /*{Double}*/\
{"[:SENSe]:MARKer:5:Y?",  SA_MARKER5_YQ}, /*{Double}*/\
{"[:SENSe]:MARKer:6:Y?",  SA_MARKER6_YQ}, /*{Double}*/\
\
...
\
{"[:SENSe]:PEAkPOInt:FReq?",  SA_PEAkPOInt_FreqQ}, /*{Double}*/\
{"[:SENSe]:PEAkPOInt:Amp?",  SA_PEAkPOInt_AmpQ}, /*{Double}*/\
\
{"[:SENSe]:MARKer:COMPENSation",SA_MARKER_Compensation},/*{Double}*/
