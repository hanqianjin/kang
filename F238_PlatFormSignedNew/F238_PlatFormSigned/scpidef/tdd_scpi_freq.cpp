...
scpi_result_t TDD_FREQUENCY_Center_Freq(scpi_t *context)
{
    ...
    if(iback)
    {
        remoteinterface::gettddremotehandle()->SCPI_ParamDouble(LTE_SCPI_FREQ_CENTER, ival);
    }
    return iback;
}
...
scpi_result_t TDD_FREQUENCY_Step_Freq(scpi_t *context)
{
    ...
    if(iback)
    {
        remoteinterface::gettddremotehandle()->SCPI_ParamDouble(LTE_SCPI_FREQ_STEP, ival);
    }
    return iback;
}
...
scpi_result_t TDD_FREQUENCY_Channel_Standard(scpi_t *context)
{
    ...
    remoteinterface::gettddremotehandle()->SCPI_ParamInt(LTE_SCPI_FREQ_CHANNEL_STD, value);
    return SCPI_RES_OK;
}
...
scpi_result_t TDD_FREQUENCY_Channel_Number(scpi_t *context)
{
    ...
    remoteinterface::gettddremotehandle()->SCPI_ParamInt(LTE_SCPI_FREQ_CHANNEL_NO, value);
    return SCPI_RES_OK;
}
...
scpi_result_t TDD_FREQUENCY_Channel_Step(scpi_t *context)
{
    ...
    remoteinterface::gettddremotehandle()->SCPI_ParamInt(LTE_SCPI_FREQ_CHANNEL_STEP, value);
    return SCPI_RES_OK;
}
...
scpi_result_t TDD_FREQUENCY_Center_FreqQ(scpi_t *context)
{
    ...
    qreal centerFreq;
    centerFreq = remoteinterface::gettddremotehandle()->SCPI_ResultDouble(LTE_SCPI_FREQ_CENTER);
...
scpi_result_t TDD_FREQUENCY_Step_FreqQ(scpi_t *context)
{
    ...
    qreal stepFreq;
    stepFreq = remoteinterface::gettddremotehandle()->SCPI_ResultDouble(LTE_SCPI_FREQ_STEP);
...
scpi_result_t TDD_FREQUENCY_Channel_StandardQ(scpi_t *context)
{
    ...
    qint32 value;
    value = remoteinterface::gettddremotehandle()->SCPI_ResultInt(LTE_SCPI_FREQ_CHANNEL_STD);
...
scpi_result_t TDD_FREQUENCY_Channel_NumberQ(scpi_t *context)
{
    ...
    qint32 value;
    value = remoteinterface::gettddremotehandle()->SCPI_ResultInt(LTE_SCPI_FREQ_CHANNEL_NO);
    if(!SCPI_ResultInt(context, value))
    {
        return SCPI_RES_ERR;
    }
...
scpi_result_t TDD_FREQUENCY_Channel_StepQ(scpi_t *context)
{
    ...
    qint32 value;
    value = remoteinterface::gettddremotehandle()->SCPI_ResultInt(LTE_SCPI_FREQ_CHANNEL_STEP);
    if(!SCPI_ResultInt(context, value))
    {
        return SCPI_RES_ERR;
    }
