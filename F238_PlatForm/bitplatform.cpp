...
{  
  ...
  if(tempertimerhandle == event->timerId())
    {
      if(batnum < 0.1)
        {
          batnum = 100;
      ...
      batterystr = QString::number((qint32)batnum) + "%";
