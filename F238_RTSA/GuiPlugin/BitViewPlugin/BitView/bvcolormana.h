...
//    {QColor("#000000"),QColor("#FF9F00"),QColor("#0070FF"),QColor("#FF9090"),QColor("#B479FF"),QColor("#FB4C70"),Qt::gray},
    {QColor("#0070FF"),QColor("#FF9F00"),QColor("#FFED00"),QColor("#FF9090"),QColor("#B479FF"),QColor("#FB4C70"),Qt::gray},
...
static _COLOR_PEN penColor[]=
{
    ...
    {Qt::white,Qt::black,Qt::black,Qt::black,Qt::black,Qt::black,Qt::black},
...
static _COLOR_BOARD boardColor[]=
{
    ...
    {Qt::gray,QColor("#E0E6E3"),Qt::black},
    {Qt::gray,QColor("#FB9B00"),QColor("#FB9B00")},
};
...
static _COLOR_LIMIT limitColor[]=
{
    // defaultmode
    {Qt::green,Qt::blue,Qt::darkRed,Qt::cyan},
    // outdoormode
    {Qt::blue,Qt::blue,Qt::red,Qt::blue},
    // nightmode
    {Qt::red,Qt::red,Qt::blue,Qt::red},
};
...
static _COLOR_MARKER markerColor[]=
{
    ...
    {QColor("#FF900E"),Qt::gray,Qt::blue,QColor("#FF900E")},
};
