...
//    QTableWidgetItem *widgetItem;
    ...
    if(currentRowIndex != (unsigned int)currentRow() || currentColumnIndex !=(unsigned int)currentColumn()) blFirstIn = true;
...
//    return;
    if(currentRowIndex != (unsigned int)currentMousePressRow) {
        sortAllItems();
        setCurrentCell(currentMousePressRow,currentMousePressColumn);
