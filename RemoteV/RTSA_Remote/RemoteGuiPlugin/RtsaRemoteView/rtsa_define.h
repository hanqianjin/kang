...
#define RTSA_SPEC_FREQ_MAX 43000000000LL  //43GHz  //Tony 0906
#define RTSA_SPEC_AMPTD_MIN  -180. // -140. dBm  //Tony 1024 -180 dBm
#define RTSA_SPEC_AMPTD_MAX  20.   // 20 dBm
...
#define RTSA_REFRESH_DEFAULT_TIME 90000 //Albert 19/05/28
...
#define RTSA_GRID_NUM_X_TICKS    10  // 0기반의 값. 실� �로 11개.
...
VARIABLE_IS_NOT_USED static unsigned char RtSa_GucRegularString[] = {'\\', '/', ':', '*', '?', '<', '>','|', ';', '&', '`', '\'', '\"' };
...
enum {
    RTSA_SHIFT_ENABLE                           = -1  ,
    RTSA_NOT_USE                                = 0   ,
    RTSA_INPUT_FREQ_CENTER                      = 1   ,
    RTSA_INPUT_FREQ_START                       = 2   ,
    RTSA_INPUT_FREQ_STOP                        ,
    RTSA_INPUT_FREQ_STEP                        ,
    RTSA_INPUT_FREQ_OFFSET                      ,
    RTSA_INPUT_FREQ_SPAN                        ,
    RTSA_BUTTON_FULL_SPAN                       ,
    RTSA_INPUT_FREQ_CHANNEL_STANDARD            ,
    RTSA_INPUT_FREQ_CHANNEL_NUM                 ,
    RTSA_INPUT_FREQ_CHANNEL_STEP                ,
    RTSA_BUTTON_CHANNEL_TYPE                    ,
    RTSA_BUTTON_AUTO_SCALE                      ,
    RTSA_INPUT_REF_LEVEL                        ,
    RTSA_BUTTON_ATTENUATION                     ,
    RTSA_INPUT_ATTEN                            ,
    RTSA_INPUT_SCALEDIV                         ,
    RTSA_INPUT_REF_OFFSET                       ,
    RTSA_SELECT_UNITS                           ,
    RTSA_BUTTON_PREAMP                          ,
    RTSA_BUTTON_SWEEP_TYPE                      ,
    RTSA_BUTTON_SWEEP_ONCE                      ,
    RTSA_BUTTON_ACQ_TIME                        ,
    RTSA_INPUT_ACQ_TIME                         ,
    RTSA_BUTTON_RBW_AUTO                        ,
    RTSA_BUTTON_RBW                             ,
    RTSA_BUTTON_FFT_WINDOWS                     ,
    RTSA_SELECT_TRIGGER_SOURCE                  ,
    RTSA_INPUT_TRIGGER_LEVEL                    ,
    RTSA_BUTTON_TRIGGER_STOPE                   ,
    RTSA_BUTTON_TRIGGER_DELAY                   ,
    RTSA_INPUT_TRIGGER_DELAY_VALUE              ,
    RTSA_INPUT_TRIGGER_PERTIMER                 ,
    RTSA_INPUT_TRIGGER_HOLDTIME                 ,
    RTSA_BUTTON_FMT_EDIT_MASK                   ,
    RTSA_BUTTON_FMT_BULDE_MASK                  ,
    RTSA_BUTTON_FMT_DELTE_ALL                   ,
    RTSA_BUTTON_FMT_MASK_TYPE                   ,
    RTSA_SELECT_FMT_TRIGGER_CRITERION           ,
    RTSA_BUTTON_FMT_INSERT_ROW                  ,
    RTSA_BUTTON_FMT_DELTE_ROW                   ,
    RTSA_BUTTON_FMT_DELETE_TABLE                ,
    RTSA_FMT_DATA_NUM                 ,
    RTSA_INPUT_FMT_SELECT_INDEX                 ,
    RTSA_INPUT_FMT_FREQ                         ,
    RTSA_INPUT_FMT_AMPT                         ,
    RTSA_BUTTON_TRACE_SELECT                    ,
    RTSA_BUTTON_TRACE_VIEW                      ,
    RTSA_BUTTON_TRACE_ALL_ON                    ,
    RTSA_SELECT_TRACE_TYPE                      ,
    RTSA_INPUT_TRACE_AVERAGE                    ,
    RTSA_SELECT_TRACE_DETECTOR                  ,
    RTSA_BUTTON_TRACE_ALL_CLEAR                 ,
    RTSA_BUTTON_MARKER_SELECT                   ,
    RTSA_BUTTON_MARKER_VIEW                     ,
    RTSA_BUTTON_MARKER_ALL_ON                   ,
    RTSA_BUTTON_MARKER_SEL                      ,
    RTSA_BUTTON_MARKER_TO                       ,
    RTSA_BUTTON_NOISE_MARKER                    ,
    RTSA_BUTTON_PEAK_TRACK                      ,
    RTSA_INPUT_MARKER_EDIT                      ,
    RTSA_BUTTON_MARKER_CLEAR_ALL                ,
    RTSA_BUTTON_MARKER_PEAK_SEARCH              ,
    RTSA_BUTTON_MARKER_MIN_SEARCH               ,
    RTSA_BUTTON_MARKER_NEXT_PEAK                ,
    RTSA_BUTTON_MARKER_NEXT_PEAK_LEFT           ,
    RTSA_BUTTON_MARKER_NEXT_PEAK_RIGHT          ,
    RTSA_BUTTON_LIMIT_SELECT                    ,
    RTSA_BUTTON_LIMIT_LINE                      ,
    RTSA_BUTTON_LIMIT_EDIT                      ,
    RTSA_BUTTON_LIMIT_EDGE                      ,
    RTSA_LIMIT_EDGE                             ,
    RTSA_BUTTON_LIMIT_DELETE_ALL                ,
    RTSA_BUTTON_LIMIT_INSERT_ROW                ,
    RTSA_BUTTON_LIMIT_DELTE_ROW                 ,
    RTSA_BUTTON_LIMIT_DELETE                    ,
    RTSA_BUTTON_LIMIT_TEST                      ,
    RTSA_BUTTON_LIMIT_TYPE                      ,
    RTSA_LIMIT_DATA_NUM                         ,
    RTSA_INPUT_LIMIT_SELECT_INDEX               ,
    RTSA_INPUT_LIMIT_FREQ                       ,
    RTSA_INPUT_LIMIT_AMPT                       ,
    RTSA_BUTTON_DISPLAY_MODLE                   ,
    RTSA_BUTTON_PERSISTENCE                     ,
    RTSA_INPUT_PERSISTENCE_TIME                 ,
    RTSA_INPUT_HIGHEST_DENSITY                  ,
    RTSA_INPUT_LOWEST_DENSITY                   ,
    RTSA_INPUT_CURVE                            ,
    RTSA_BUTTON_AUTO_ADJUST             ,
    RTSA_INPUT_MEASUREMENT                     ,
    RTSA_INPUT_PREAMP                            ,
    RTSA_INPUT_MANUAL_RBW                  ,
    RTSA_INPUT_MANUAL_VBW                     ,
    RTSA_INPUT_AUTO_RBW                         ,
    RTSA_INPUT_AUTO_VBW                        ,
    RTSA_INPUT_SWEEP_TIME                       ,
    RTSA_INPUT_SWEEP_TYPE                      ,
    RTSA_INPUT_OVERLAP                            ,
...
* @param (us)
* @Author Albert
* 当2次FFT交�� 后不出现GAP空隙的情况下，
* （2 * 窗长 - 交�� 点数 - 1）/ fs    或者使用R&S提供的公式（2 - 重�� 率）* 窗长 / fs；
* 当2次FFT交�� 后出现GAP空隙的情况下，最短信号持续时间：（窗长 + FFT帧长 - 交�� 点数 - 1）/fs
* 或者使用R&S提供的公式（1 / fFFT）+ 窗长 / fs，信号错过或者丢失的时间：（FFT帧长 - 窗长 - 交�� 点数）/fs
...
/**
* @brief FFT帧数采用19bit，最大可以设置的数值为524288，在此基础上还要满足至少3帧的重�� 率，即
* 最大可设置的数值为174762
* @param
* @Author Albert
* @date 2019-08-14
...
VARIABLE_IS_NOT_USED static const char* rtsa_qssMode[3] = {"indoor","outdoor","night"};
...
enum{
    RTSA_LINK_FLG_DEFULT = 0, //Load SoftOara
    RTSA_LINK_FLG_LOAD = 1, //Load local file
    RTSA_LINK_FLG_READ = 2, //Read Scpi Data
};
