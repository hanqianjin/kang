...
void plusmode::AddBtnGroups(quint32 *tmode)
{
  ...
  ltefddbtngroup->addButton(ui->pushButton_58,FDD_PTS_MEAS);
  ...
  ltefddbtngroup->addButton(ui->pushButton_65,FDD_TAE_MEAS);
  ...
  ltefddbtngroup->addButton(ui->pushButton_69,FDD_MULP_MEAS);
  ltefddbtngroup->addButton(ui->pushButton_70,FDD_CONCHA_MEAS);
  ltefddbtngroup->addButton(ui->pushButton_71,FDD_DATAGRAM_MEAS);
  ltefddbtngroup->addButton(ui->pushButton_72,FDD_RMAP_MEAS);
  ltefddbtngroup->addButton(ui->pushButton_73,FDD_CARAGG_MEAS);
  ltefddbtngroup->addButton(ui->pushButton_94,FDD_CONFOR_TEST);
  ltefddbtngroup->addButton(ui->pushButton_95,FDD_MAIN_TEST);
  ltefddbtngroup->addButton(ui->pushButton_96,FDD_SIG_PERFOR);
  ltefddbtngroup->addButton(ui->pushButton_97,FDD_DAS_TEST);
  ltefddbtngroup->addButton(ui->pushButton_98,FDD_CCDF);
  ...
  ltetddbtngroup->addButton(ui->pushButton_89,TDD_MULP_MEAS);
  ltetddbtngroup->addButton(ui->pushButton_90,TDD_CONCHA_MEAS);
  ltetddbtngroup->addButton(ui->pushButton_91,TDD_DATAGRAM_MEAS);
  ltetddbtngroup->addButton(ui->pushButton_92,TDD_RMAP_MEAS);
  ltetddbtngroup->addButton(ui->pushButton_93,TDD_CARAGG_MEAS);
  ltetddbtngroup->addButton(ui->pushButton_99,TDD_CONFOR_TEST);
  ltetddbtngroup->addButton(ui->pushButton_100,TDD_MAIN_TEST);
  ltetddbtngroup->addButton(ui->pushButton_101,TDD_SIG_PERFOR);
  ltetddbtngroup->addButton(ui->pushButton_102,TDD_DAS_TEST);
  ltetddbtngroup->addButton(ui->pushButton_103,TDD_CCDF);
  ...
  fgnrbtngroup->addButton(ui->pushButton_52,FGNR_CHANNEL_POWER);
  fgnrbtngroup->addButton(ui->pushButton_105,FGNR_OCCUPIED_BW);
  fgnrbtngroup->addButton(ui->pushButton_106,FGNR_MULTI_BEAM);
  fgnrbtngroup->addButton(ui->pushButton_107,FGNR_SINGLE_BEAM);
