...
public://Measure Interface
    ...
    void   setChannelPower_ChannelBW(quint64 uChBw);//quint32 is Hz
    quint64 getChannelPower_ChannelBW();
    qreal getChannelPower();

    void   setACP_ChannelBW(quint64 uChBw);
    void   setACP_ChannelSP(quint64 uChSp);
...
public://Frequency Interface
    ...
    void setCFFreq(quint64 uCFFreq);
    quint64 getCFFreq();

    void setFreqOffset(qint64 uFreqOffset);
    qint64 getFreqOffset();

    void setSpan(quint64 uSpanFeq);
    quint64 getSpan();
...
public://Sweep Interface
    ...
    void setTriggerMode(quint32 uTiggerMode);
...
public://Trace Interface
    ...
    void setDetectorMode(quint32 uTraceDetectorMode);
...
public://Marker Interface
    ...
    void setMarkerNoiseStatus(qint32 markerNoiseStatus,qint32 markerIndex =-1);
...
public://IF mode and ref select
    void setIFMode(quint32 uifMode);
    quint32 getIFMode();
    #if 0
...
private:
    ...
    quint32 CalculateAutoLimitMax(quint32 start,quint32 stop);
...
public: // only for remote
    ...
    void sendFileToRemote(QString strFile,QString strSavePath);
    void getFileFromRemote(QString strFile,QString strSavePath);
public:
