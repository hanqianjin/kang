...
user_variable::user_variable()
{
    ...
    gDetectorMode    = SA_POSITIVE_PEAK;
    gTmpDetectorMode = SA_SAMPLE;//Johnson 1128
    ...
    memset(gMarkerFreqCount,SA_OFF,sizeof(qint32)*MARKER_TOTAL_CNT);
...
void user_variable::markerEditInNputMarkerPosCalculatorFunc(quint64 freq, qint32 InputType)
{
    qint32 i = 0;
    quint64 calculatorFreq = 0;
    quint64 vigeoFreq = 0;
