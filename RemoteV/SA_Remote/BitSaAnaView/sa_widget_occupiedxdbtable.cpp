...
void sa_widget_OccupiedXdBTable::refreshPixmap()
{
    ...
    painter.drawText(OCCUPIEDXDB_LEFT_MARGIN,SA_OCC_SPACE_LINES * 5 + fm.height() * 4, fm.width("Occupied BW"), fm.height(), Qt::AlignRight, "Occupied BW");
    ...
    painter.drawText(OCCUPIEDXDB_LEFT_MARGIN,SA_OCC_SPACE_LINES * 6 + fm.height() * 5, fm.width("xdB BW"), fm.height(), Qt::AlignRight, "xdB BW");
