 ...
 * @author Johnson
 */
bool paraSaveLoad::paraInit_StateFile()
{
    ...
    //gAllMode_State.gConfig_ShareMem.uIFMode = SA_sm_config_sweep->uIFMode;
#if USABLE
...
bool paraSaveLoad::paraInit_StateAndDataFile()
{
    ...
    //gAllModeState_MsData.gConfig_ShareMem.uIFMode = SA_sm_config_sweep->uIFMode;
#if USABLE
...
//    }
    ...
    memcpy(globalUserVariable->gMarkerFreqCount,pVariable->gConfig_Marker.gMarkerFreqCount,sizeof(qint32)*MARKER_TOTAL_CNT);
...
//    }
    ...
    memcpy(pVariable->gConfig_Marker.gMarkerFreqCount,globalUserVariable->gMarkerFreqCount,sizeof(qint32)*MARKER_TOTAL_CNT);
...
bool paraSaveLoad::loadStatefile( QString FilePath)
{
    ...
    //SA_sm_config_sweep->uIFMode = gAllMode_State.gConfig_ShareMem.uIFMode;
#if USABLE
...
bool paraSaveLoad::loadStateAndDataFile(QString FilePath)
{
    ...
    //SA_sm_config_sweep->uIFMode = gAllModeState_MsData.gConfig_ShareMem.uIFMode;
#if USABLE
