...
{
    /*if(index == SA_NONE_SOURCE)
    {
        mControl->setDoorControlSwitch(SA_CLOSE_DCSWEEP,SA_EXTERN_TRIGGER);
        mControl->setDoorControlSwitch(SA_CLOSE_DCSWEEP,SA_RFBURST_TRIGGER);
        mControl->setDoorControlSwitch(SA_CLOSE_DCSWEEP,SA_PERIOD_TRIGGER);
    }*/
