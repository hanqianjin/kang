...
#ifndef __BitDisaType_H__
#define __BitDisaType_H__   
...
#include <limits.h>
#include <sys/types.h>
typedef u_int64_t           DiUInt64;
typedef int64_t             DiInt64;
#define _DI_INT64_UINT64_DEFINED
#if defined(LONG_MAX) && (LONG_MAX > 0x7FFFFFFFL)
#define _DISA_END_IS_64_BIT
#endif
#endif  

#if defined(_DI_INT64_UINT64_DEFINED)
