...
#define SA_UMOUNT_BUSY           (ERR_MASK|0X5e)//udisk umont busy
#define SA_UMOUNT_ERR            (ERR_MASK|0X5f)//udisk umont err
...
#define SA_MCU_OPEN            (ERR_MASK|0X72)//
#define SA_MCU_READ            (ERR_MASK|0X73)//
#define SA_MCU_WRITE           (ERR_MASK|0X74)//
#define SA_MCU_CLOSE           (ERR_MASK|0X75)//


#define SA_DEV_MUTEX_INIT      (ERR_MASK|0X76)//驱动线程锁初始化失败
#define SA_DEV_MUTEX_LOCK      (ERR_MASK|0X77)//驱动线程锁上锁失败
#define SA_DEV_MUTEX_UNLOCK    (ERR_MASK|0X78)//驱动线程锁解锁失败

#define SA_RED_LED_OPEN        (ERR_MASK|0X79)
#define SA_RED_LED_CLOSE       (ERR_MASK|0X80)
#define SA_GREEN_LED_OPEN      (ERR_MASK|0X81)
#define SA_GREEN_LED_CLOSE     (ERR_MASK|0X82)
#define SA_BLUE_LED_OPEN       (ERR_MASK|0X83)
#define SA_BLUE_LED_CLOSE      (ERR_MASK|0X84)

#define SA_LCD_PWR_OPEN        (ERR_MASK|0X85)
#define SA_LCD_PWR_CLOSE       (ERR_MASK|0X86)

#define SA_BATTERY_READ        (ERR_MASK|0X87)//

#define SA_MICRO_USB_OPEN      (ERR_MASK|0X88)//
#define SA_MICRO_USB_CLOSE     (ERR_MASK|0X89)//
#define SA_MICRO_USB_READ_TIME_OUT     (ERR_MASK|0X90)//
#define SA_MICRO_USB_READ     (ERR_MASK|0X91)//

#define SA_LCD_SWITCH_OPEN    (ERR_MASK|0X92)//
#define SA_LCD_SWITCH_CLOSE   (ERR_MASK|0X93)//
//end gaven 
//--------------------------------------------------------------------
